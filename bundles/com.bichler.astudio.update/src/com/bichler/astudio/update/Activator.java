package com.bichler.astudio.update;
...
public class Activator extends InternationalActivator {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.bichler.astudio.update"; //$NON-NLS-1$
	public static final String BUNDLE_NAME = "com.bichler.astudio.update.resource.custom";
	// The shared instance
