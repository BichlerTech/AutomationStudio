...
public class SiemensBooleanTransform2UnsignedInteger extends SiemensTransform2UnsignedInteger {
	@Override
	public Object transToIntern(ComByteMessage value) {
		...
		return new UnsignedInteger(trans);
	}

	@Override
	public byte[] transToDevice(Object value) {
		byte[] data = new byte[1];
		if (((UnsignedInteger) value).intValue() == 1)
			data[0] = 1;
		else
			data[0] = 0;
		return data;
