...
public class StudioImages
{
  ...
  public static final String ICON_HMI = ICONS_PATH + ICONS_16_PATH + "hmi.png"; //$NON-NLS-1$
  ...
  public static final String ICON_COMET_16 = ICONS_PATH + ICONS_16_PATH + "comet.png"; //$NON-NLS-1$
  public static final String ICON_SERVER = ICONS_PATH + ICONS_16_PATH + "server.png"; //$NON-NLS-1$
  ...
  public static final String ICON_DATASERVER = ICONS_PATH + ICONS_16_PATH + "dataserver.png"; //$NON-NLS-1$
  public static final String ICON_IECPROJECT = ICONS_PATH + ICONS_16_PATH + "iec.png"; //$NON-NLS-1$
  public static final String ICON_IECHARDWARE = ICONS_PATH + ICONS_16_PATH + "iec_plc.png"; //$NON-NLS-1$
  public static final String ICON_IECDATATYPE = ICONS_PATH + ICONS_16_PATH + "iec_datatype.png"; //$NON-NLS-1$
  public static final String ICON_IECDT = ICONS_PATH + ICONS_16_PATH + "iec_dt.png"; //$NON-NLS-1$
  public static final String ICON_IECGLOBALVAR = ICONS_PATH + ICONS_16_PATH + "globalvar.png"; //$NON-NLS-1$
  public static final String ICON_IECTIMEBAR = ICONS_PATH + ICONS_16_PATH + "timebar.png"; //$NON-NLS-1$
  public static final String ICON_IECCONTENT_PROPOSAL = ICONS_PATH + ICONS_16_PATH + "content_proposal.png"; //$NON-NLS-1$
  public static final String ICON_IECPICTURE = ICONS_PATH + ICONS_16_PATH + "hmi.png"; //$NON-NLS-1$
  public static final String ICON_HOSTCONNECTION = ICONS_PATH + SVG_SITE_PATH + ICONS_16_PATH + "hostconnection.png"; //$NON-NLS-1$
  public static final String ICON_HOSTCONNECTION_GREEN = ICONS_PATH + SVG_SITE_PATH + ICONS_16_PATH
      + "hostconnection_green.png"; //$NON-NLS-1$
  ...
  public static final String ICON_OPCUAHISTORY = ICONS_PATH + ICONS_16_PATH + "version.png"; //$NON-NLS-1$
  public static final String ICON_OPCUAVERSION = ICONS_PATH + ICONS_16_PATH + "version.png"; //$NON-NLS-1$
  public static final String ICON_OPCUACERTIFICATE = ICONS_PATH + SVG_SITE_PATH + ICONS_16_PATH + "certificate.png"; //$NON-NLS-1$
  public static final String ICON_OPCUAINFORMATIONMODEL = ICONS_PATH + SVG_SITE_PATH + ICONS_16_PATH
      + "information.png"; //$NON-NLS-1$
  ...
  public static final String ICON_OPCUAMODULES = ICONS_PATH + SVG_SITE_PATH + ICONS_16_PATH + "drivers.png"; //$NON-NLS-1$
  ...
  public static final String ICON_TRUST = ICONS_PATH + ICONS_24_PATH + "trust.png"; //$NON-NLS-1$
  public static final String ICON_ARROW_DOWN = ICONS_PATH + ICONS_24_PATH + "arrow_down.png";
  public static final String ICON_ARROW_UP = ICONS_PATH + ICONS_24_PATH + "arrow_up.png";
  public static final String ICON_SELECT_NONE = ICONS_PATH + ICONS_24_PATH + "select_none.png";
  public static final String ICON_SELECT_ALL = ICONS_PATH + ICONS_24_PATH + "select_all.png";
  public static final String ICON_SEARCH = ICONS_PATH + ICONS_16_PATH + "search.png";
  public static final String ICON_16_FUNCTIONBLOCK = ICONS_PATH + ICONS_16_PATH + "functionblock.png"; //$NON-NLS-1$
  public static final String ICON_16_LADDER = ICONS_PATH + ICONS_16_PATH + "contact.png"; //$NON-NLS-1$
  public static final String ICON_16_ST = ICONS_PATH + ICONS_16_PATH + "expression.png"; //$NON-NLS-1$
  public static final String ICON_32_FUNCTIONBLOCK = ICONS_PATH + ICONS_32_PATH + "functionblock.png"; //$NON-NLS-1$
  public static final String ICON_32_LADDER = ICONS_PATH + ICONS_32_PATH + "contact.png"; //$NON-NLS-1$
  public static final String ICON_32_ST = ICONS_PATH + ICONS_32_PATH + "expression.png"; //$NON-NLS-1$
  /**
   * 32x32
   */
  ...
  public static final String ICON_PALETTE_LASSOSELETION = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "lassoselection.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_LASSOSELETION_HOVER = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "lassoselection_hover.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_LASSOSELETION_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "lassoselection_selected.png"; //$NON-NLS-1$
  ...
  public static final String ICON_PALETTE_RECT_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "rect_selected.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_FREEHANDRECT = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "freehandrect.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_FREEHANDRECT_HOVER = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "freehandrect_hover.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_FREEHANDRECT_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "freehandrect_selected.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_SQUARE = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH + "square.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_SQUARE_HOVER = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "square_hover.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_SQUARE_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "square_selected.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_CIRCLE = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH + "circle.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_CIRCLE_HOVER = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "circle_hover.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_CIRCLE_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "circle_selected.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_ELLIPSE = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH + "ellipse.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_ELLIPSE_HOVER = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "ellipse_hover.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_ELLIPSE_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "ellipse_selected.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_FREEHANDELLIPSE = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "freehandellipse.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_FREEHANDELLIPSE_HOVER = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "freehandellipse_hover.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_FREEHANDELLIPSE_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "freehandellipse_selected.png"; //$NON-NLS-1$
  ...
  public static final String ICON_PALETTE_LINE_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "line_selected.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_PENCIL = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH + "pencil.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_PENCIL_HOVER = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "pencil_hover.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_PENCIL_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "pencil_selected.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_CONNECT = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH + "connect.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_CONNECT_HOVER = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "connect_hover.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_CONNECT_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "connect_selected.png"; //$NON-NLS-1$
  ...
  public static final String ICON_PALETTE_WIREFRAME_HOVER = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "wireframe.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_WIREFRAME_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "wireframe.png"; //$NON-NLS-1$
  ...
  public static final String ICON_COLORPROP_LINEARGRADIENT = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "lineargradient.png"; //$NON-NLS-1$
  public static final String ICON_COLORPROP_RADIALGRADIENT = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "radialgradient.png";
  public static final String ICON_PALETTE_POLYLINE = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH + "polyline.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_POLYLINE_HOVER = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "polyline_hover.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_POLYLINE_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "polyline_selected.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_POLYGON = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH + "polygon.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_POLYGON_HOVER = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "polygon_hover.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_POLYGON_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "polygon_selected.png"; //$NON-NLS-1$
  ...
  public static final String ICON_PALETTE_TEXT_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "text_selected.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_IMAGE = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH + "image.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_IMAGE_HOVER = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "image_hover.png"; //$NON-NLS-1$
  public static final String ICON_PALETTE_IMAGE_SELECTED = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "image_selected.png"; //$NON-NLS-1$
  ...
  public static final String ICON_PALETTE_CONVERTTOPATH = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "converttopath.png"; //$NON-NLS-1$
  ...
  public static final String ICON_PALETTE_OPENCLOSEPATH = ICONS_PATH + SVG_PALETTE_PATH + ICONS_32_PATH
      + "openclosepath.png"; //$NON-NLS-1$
  /** */
