package com.bichler.astudio.editor.aggregated.clientbrowser;
...
{
  // The plug-in ID
  public static final String PLUGIN_ID = "com.bichler.astudio.editor.aggregated.clientbrowser"; //$NON-NLS-1$
  public static final String BUNDLE_NAME = "com.bichler.astudio.editor.aggregated.clientbrowser.resource.custom"; //$NON-NLS-1$
  // The shared instance
