...
/**
 * this class transforms from Boolean (XML-DA) to UnsignedByte (OPC UA) and vice
 * versa
 * 
 ...
 * 
 */
public class XML_DA_TransformBoolean2UnsignedByte implements XML_DA_Transformation {
	@Override
