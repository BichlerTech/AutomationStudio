...
/**
 * this class transforms from Byte (XML-DA) to UnsignedLong (OPC UA) and vice
 * versa
 * 
 ...
 * 
 */
public class XML_DA_TransformByte2UnsignedLong implements XML_DA_Transformation {
	@Override
	...
	public Byte transToDevice(Object value) {
		long d = ((UnsignedLong) value).longValue();
		d = Math.min(d, Byte.MAX_VALUE);
		d = Math.max(d, Byte.MIN_VALUE);
		return (byte) d;
	}
