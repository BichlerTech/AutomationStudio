...
/**
 * this class transforms from UnsignedByte (XML-DA) to UnsignedLong (OPC UA) and
 * vice versa
 * 
 ...
 * 
 */
public class XML_DA_TransformUnsignedByte2UnsignedLong implements XML_DA_Transformation {
	@Override
	public Object transToIntern(Object value) throws ClassCastException, ValueOutOfRangeException {
		return new UnsignedLong(((UnsignedByte) value).intValue());
	}
