...
/**
 * this class transforms from UnsignedLong (XML-DA) to Long (OPC UA) and vice
 * versa
 * 
 ...
 * 
 */
public class XML_DA_TransformUnsignedLong2Long implements XML_DA_Transformation {
	@Override
	...
	public UnsignedLong transToDevice(Object value) {
		return new UnsignedLong(((Long) value).longValue());
	}
