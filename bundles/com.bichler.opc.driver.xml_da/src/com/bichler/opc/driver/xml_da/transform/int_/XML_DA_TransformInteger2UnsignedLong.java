...
/**
 * this class transforms from Integer (XML-DA) to UnsignedLong (OPC UA) and vice
 * versa
 * 
 ...
 * 
 */
public class XML_DA_TransformInteger2UnsignedLong implements XML_DA_Transformation {
	@Override
