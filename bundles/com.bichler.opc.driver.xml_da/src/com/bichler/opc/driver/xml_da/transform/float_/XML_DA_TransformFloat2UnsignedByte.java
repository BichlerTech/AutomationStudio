...
/**
 * this class transforms from Float (XML-DA) to UnsignedByte (OPC UA) and vice
 * versa
 * 
 ...
 * 
 */
public class XML_DA_TransformFloat2UnsignedByte implements XML_DA_Transformation {
	@Override
