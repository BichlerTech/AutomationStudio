...
public class RequestOptions implements java.io.Serializable {
	...
	public RequestOptions(boolean returnErrorText, boolean returnDiagnosticInfo, boolean returnItemTime,
			boolean returnItemPath, boolean returnItemName, java.util.Calendar requestDeadline,
			java.lang.String clientRequestHandle, java.lang.String localeID) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.returnErrorText == other.isReturnErrorText()
				&& this.returnDiagnosticInfo == other.isReturnDiagnosticInfo()
				&& this.returnItemTime == other.isReturnItemTime() && this.returnItemPath == other.isReturnItemPath()
				&& this.returnItemName == other.isReturnItemName()
				&& ((this.requestDeadline == null && other.getRequestDeadline() == null)
						|| (this.requestDeadline != null && this.requestDeadline.equals(other.getRequestDeadline())))
