...
public class SubscriptionPolledRefresh implements java.io.Serializable {
	...
	public SubscriptionPolledRefresh(org.opcfoundation.webservices.XMLDA._1_0.RequestOptions options,
			java.lang.String[] serverSubHandles, java.util.Calendar holdTime, int waitTime, boolean returnAllItems) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof SubscriptionPolledRefresh))
			return false;
		...
		_equals = true
				&& ((this.options == null && other.getOptions() == null)
						|| (this.options != null && this.options.equals(other.getOptions())))
				...
				&& ((this.holdTime == null && other.getHoldTime() == null)
						|| (this.holdTime != null && this.holdTime.equals(other.getHoldTime())))
				&& this.waitTime == other.getWaitTime() && this.returnAllItems == other.isReturnAllItems();
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getServerSubHandles() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getServerSubHandles()); i++) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			SubscriptionPolledRefresh.class, true);
	static {
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "Options"));
		elemField.setXmlType(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "RequestOptions"));
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "ServerSubHandles"));
