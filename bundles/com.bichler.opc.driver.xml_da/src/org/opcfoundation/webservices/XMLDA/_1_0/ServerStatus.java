...
public class ServerStatus implements java.io.Serializable {
	...
	public ServerStatus(java.lang.String statusInfo, java.lang.String vendorInfo, java.lang.String[] supportedLocaleIDs,
			org.opcfoundation.webservices.XMLDA._1_0.InterfaceVersion[] supportedInterfaceVersions,
			java.util.Calendar startTime, java.lang.String productVersion) {
	 ...
	 */
	public void setSupportedInterfaceVersions(
			org.opcfoundation.webservices.XMLDA._1_0.InterfaceVersion[] supportedInterfaceVersions) {
		this.supportedInterfaceVersions = supportedInterfaceVersions;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				&& ((this.statusInfo == null && other.getStatusInfo() == null)
						|| (this.statusInfo != null && this.statusInfo.equals(other.getStatusInfo())))
				&& ((this.vendorInfo == null && other.getVendorInfo() == null)
						|| (this.vendorInfo != null && this.vendorInfo.equals(other.getVendorInfo())))
				...
				&& ((this.supportedInterfaceVersions == null && other.getSupportedInterfaceVersions() == null)
						|| (this.supportedInterfaceVersions != null && java.util.Arrays
								.equals(this.supportedInterfaceVersions, other.getSupportedInterfaceVersions())))
	...
	public synchronized int hashCode() {
		...
		if (getSupportedLocaleIDs() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getSupportedLocaleIDs()); i++) {
		...
		if (getSupportedInterfaceVersions() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getSupportedInterfaceVersions()); i++) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ServerStatus.class, true);
	static {
		typeDesc.setXmlType(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "ServerStatus"));
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "StatusInfo"));
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "VendorInfo"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "SupportedLocaleIDs"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		...
		elemField.setXmlType(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "interfaceVersion"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setMaxOccursUnbounded(true);
		typeDesc.addFieldDesc(elemField);
