...
public class SubscriptionPolledRefreshResponse implements java.io.Serializable {
	...
	public SubscriptionPolledRefreshResponse(
			...
			org.opcfoundation.webservices.XMLDA._1_0.OPCError[] errors, boolean dataBufferOverflow) {
	...
	/**
	 * Gets the subscriptionPolledRefreshResult value for this
	...
	/**
	 * Sets the subscriptionPolledRefreshResult value for this
	 * SubscriptionPolledRefreshResponse.
	 * 
	 * @param subscriptionPolledRefreshResult
	 */
	public void setSubscriptionPolledRefreshResult(
			org.opcfoundation.webservices.XMLDA._1_0.ReplyBase subscriptionPolledRefreshResult) {
		this.subscriptionPolledRefreshResult = subscriptionPolledRefreshResult;
	}

	/**
	 * Gets the invalidServerSubHandles value for this
	 * SubscriptionPolledRefreshResponse.
	 * 
	...
	/**
	 * Sets the invalidServerSubHandles value for this
	 * SubscriptionPolledRefreshResponse.
	 * 
	...
	public void setRItemList(int i,
			org.opcfoundation.webservices.XMLDA._1_0.SubscribePolledRefreshReplyItemList _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof SubscriptionPolledRefreshResponse))
			return false;
		...
		_equals = true
				&& ((this.subscriptionPolledRefreshResult == null && other.getSubscriptionPolledRefreshResult() == null)
						|| (this.subscriptionPolledRefreshResult != null && this.subscriptionPolledRefreshResult
								.equals(other.getSubscriptionPolledRefreshResult())))
				&& ((this.invalidServerSubHandles == null && other.getInvalidServerSubHandles() == null)
						|| (this.invalidServerSubHandles != null && java.util.Arrays
								.equals(this.invalidServerSubHandles, other.getInvalidServerSubHandles())))
				&& ((this.RItemList == null && other.getRItemList() == null)
						|| (this.RItemList != null && java.util.Arrays.equals(this.RItemList, other.getRItemList())))
	...
	public synchronized int hashCode() {
		...
		if (getInvalidServerSubHandles() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getInvalidServerSubHandles()); i++) {
		...
		if (getRItemList() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getRItemList()); i++) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			SubscriptionPolledRefreshResponse.class, true);
	static {
		...
		elemField.setXmlName(new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/",
				"SubscriptionPolledRefreshResult"));
		elemField.setXmlType(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "ReplyBase"));
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "RItemList"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/",
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "Errors"));
		elemField.setXmlType(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "OPCError"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setMaxOccursUnbounded(true);
		typeDesc.addFieldDesc(elemField);
