...
public class ArrayOfDouble implements java.io.Serializable {
	...
	public ArrayOfDouble(double[] _double) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfDouble))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this._double == null && other.get_double() == null)
				|| (this._double != null && java.util.Arrays.equals(this._double, other.get_double())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		int _hashCode = 1;
		if (get_double() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(get_double()); i++) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfDouble.class, true);
	static {
		typeDesc.setXmlType(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "ArrayOfDouble"));
		org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
		elemField.setFieldName("_double");
		elemField
				.setXmlName(new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "double"));
