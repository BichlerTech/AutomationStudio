...
public class BrowseResponse implements java.io.Serializable {
	...
	public BrowseResponse(org.opcfoundation.webservices.XMLDA._1_0.ReplyBase browseResult,
			org.opcfoundation.webservices.XMLDA._1_0.BrowseElement[] elements,
			org.opcfoundation.webservices.XMLDA._1_0.OPCError[] errors, java.lang.String continuationPoint,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				&& ((this.browseResult == null && other.getBrowseResult() == null)
						|| (this.browseResult != null && this.browseResult.equals(other.getBrowseResult())))
				&& ((this.elements == null && other.getElements() == null)
						|| (this.elements != null && java.util.Arrays.equals(this.elements, other.getElements())))
	...
	public synchronized int hashCode() {
		...
		if (getElements() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getElements()); i++) {
	...
	static {
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "BrowseResult"));
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "Elements"));
		elemField.setXmlType(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "BrowseElement"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
