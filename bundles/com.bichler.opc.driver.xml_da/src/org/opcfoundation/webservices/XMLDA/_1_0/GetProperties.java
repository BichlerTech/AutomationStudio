...
public class GetProperties implements java.io.Serializable {
	...
	public GetProperties(org.opcfoundation.webservices.XMLDA._1_0.ItemIdentifier[] itemIDs,
			javax.xml.namespace.QName[] propertyNames, java.lang.String localeID, java.lang.String clientRequestHandle,
			java.lang.String itemPath, boolean returnAllProperties, boolean returnPropertyValues,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof GetProperties))
			return false;
		...
		_equals = true
				&& ((this.itemIDs == null && other.getItemIDs() == null)
						|| (this.itemIDs != null && java.util.Arrays.equals(this.itemIDs, other.getItemIDs())))
	...
	public synchronized int hashCode() {
		...
		int _hashCode = 1;
		if (getItemIDs() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getItemIDs()); i++) {
	...
	static {
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "ItemIDs"));
		elemField.setXmlType(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "ItemIdentifier"));
