...
public class ReplyBase implements java.io.Serializable {
	...
	public ReplyBase(java.util.Calendar rcvTime, java.util.Calendar replyTime, java.lang.String clientRequestHandle,
			java.lang.String revisedLocaleID, org.opcfoundation.webservices.XMLDA._1_0.ServerState serverState) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				&& ((this.rcvTime == null && other.getRcvTime() == null)
						|| (this.rcvTime != null && this.rcvTime.equals(other.getRcvTime())))
				&& ((this.replyTime == null && other.getReplyTime() == null)
						|| (this.replyTime != null && this.replyTime.equals(other.getReplyTime())))
				...
				&& ((this.revisedLocaleID == null && other.getRevisedLocaleID() == null)
						|| (this.revisedLocaleID != null && this.revisedLocaleID.equals(other.getRevisedLocaleID())))
				&& ((this.serverState == null && other.getServerState() == null)
						|| (this.serverState != null && this.serverState.equals(other.getServerState())));
		__equalsCalc = null;
		return _equals;
	}
	...
	static {
		...
		attrField.setXmlType(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "serverState"));
		typeDesc.addFieldDesc(attrField);
	}
