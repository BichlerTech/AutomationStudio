...
public class OPCQuality implements java.io.Serializable {
	...
	public OPCQuality(org.opcfoundation.webservices.XMLDA._1_0.QualityBits qualityField,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				&& ((this.qualityField == null && other.getQualityField() == null)
						|| (this.qualityField != null && this.qualityField.equals(other.getQualityField())))
				&& ((this.limitField == null && other.getLimitField() == null)
						|| (this.limitField != null && this.limitField.equals(other.getLimitField())))
				&& ((this.vendorField == null && other.getVendorField() == null)
						|| (this.vendorField != null && this.vendorField.equals(other.getVendorField())));
		__equalsCalc = null;
		return _equals;
	}
	...
	static {
		...
		attrField.setXmlType(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "qualityBits"));
		typeDesc.addFieldDesc(attrField);
		attrField = new org.apache.axis.description.AttributeDesc();
		attrField.setFieldName("limitField");
		attrField.setXmlName(new javax.xml.namespace.QName("", "LimitField"));
		attrField.setXmlType(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "limitBits"));
		typeDesc.addFieldDesc(attrField);
		attrField = new org.apache.axis.description.AttributeDesc();
