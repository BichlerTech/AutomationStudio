...
public class SubscribeItemValue implements java.io.Serializable {
	...
	public SubscribeItemValue(org.opcfoundation.webservices.XMLDA._1_0.ItemValue itemValue, int revisedSamplingRate) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof SubscribeItemValue))
			return false;
		...
		_equals = true
				&& ((this.itemValue == null && other.getItemValue() == null)
						|| (this.itemValue != null && this.itemValue.equals(other.getItemValue())))
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			SubscribeItemValue.class, true);
	static {
		typeDesc.setXmlType(
				new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "SubscribeItemValue"));
