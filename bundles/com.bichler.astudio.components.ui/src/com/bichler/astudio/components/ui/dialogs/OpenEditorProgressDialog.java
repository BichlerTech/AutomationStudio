...
public class OpenEditorProgressDialog extends Dialog {
	 ...
	 * @param style
	 */
	public OpenEditorProgressDialog(Shell parent, int style) {
		super(parent, style);
	}
	 ...
	 * @param style
	 */
	public OpenEditorProgressDialog(Shell parent, int style, String hostname) {
		super(parent, style);
	...
	private void createContents() {
		...
		lblConnectingToHost.setText("connecting to host: " + this.hostname);

		progressBar = new ProgressBar(shell, SWT.SMOOTH);
		GridData gd_progressBar = new GridData(SWT.FILL, SWT.FILL, true, true,
				1, 1);
