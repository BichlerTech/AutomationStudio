...
public class SiemensActivator extends InternationalActivator {
	// The plug-in ID
	private static final String PLUGIN_ID = "com.bichler.astudio.editor.siemens.1.0.1"; //$NON-NLS-1$
	...
	protected void initializeImageRegistry(ImageRegistry registry) {
		registry.put(SiemensSharedImages.ICON_TEST, getImageDescriptor(SiemensSharedImages.ICON_TEST));
