...
public class UABoxStatusDialog extends Dialog {
	...
	public UABoxStatusDialog(Shell parent, IFileSystem filesystem, int style) {
		super(parent, style);
		setText(CustomString.getString(DeviceActivator.getDefault().RESOURCE_BUNDLE,
	...
	private void createContents() {
		...
		shlUaboxControl.setText(CustomString.getString(DeviceActivator.getDefault().RESOURCE_BUNDLE,
				"com.bichler.astudio.device.dialog.uaboxstatus.title"));
		...
		btnStart.setText(CustomString.getString(DeviceActivator.getDefault().RESOURCE_BUNDLE,
		...
		btnStop.setText(CustomString.getString(DeviceActivator.getDefault().RESOURCE_BUNDLE,
