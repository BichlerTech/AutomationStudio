...
public class CalculationByteTarget extends CalculationTarget
{
  public CalculationByteTarget()
  {
  ...
  /**
   * change java script value into Byte representation possible java scirpt
