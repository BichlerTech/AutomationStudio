package com.bichler.astudio.core.user.widget;
...
public class UserComboFieldEditor extends FieldEditor {
	 ...
	 */
	public UserComboFieldEditor(String name, String labelText, String[][] entryNamesAndValues, Composite parent) {
		init(name, labelText);
