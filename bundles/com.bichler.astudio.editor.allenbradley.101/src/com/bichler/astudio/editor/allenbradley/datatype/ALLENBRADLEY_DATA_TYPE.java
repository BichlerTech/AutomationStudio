...
public enum ALLENBRADLEY_DATA_TYPE {
	BOOL, SINT, INT, DINT, LINT, USINT, UINT, UDINT, ULINT, REAL, LREAL, /*ITIME, TIME, FTIME, LTIME, DATE, TIME_OF_DAY, DATE_AND_TIME,*/ STRING, /*STRING2, STRINGN, SHORT_STRING, STRINGI,*/ BYTE, UNDEFINED;//, WORD, DWORD, LWORD, EPATH, ENGUNIT, COMPLEX;
