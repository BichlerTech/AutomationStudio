...
public class OPCUAAllenBradleyValidationHandler extends AbstractOPCUAValidationHandler
{
  ...
  public void onValidateDatapoints(OPCUAValidationDriverParameter trigger, String path)
  {
    ...
    try
    {
      ...
      List<AllenBradleyDPItem> items = importer.loadDPs(input,
      ...
      // validate items
      boolean valid = true;
      for (AllenBradleyDPItem item : items)
      {
      ...
      // .info(CustomString.getString(allenbradleyActivator.getDefault().RESOURCE_BUNDLE,
  ...
  private boolean validateItem(AllenBradleyDPItem item)
  {
