...
public class CreateOPCUADriverHandler extends AbstractOPCCreateDriverModel
{
  ...
  public Object execute(ExecutionEvent event) throws ExecutionException
  {
    ...
    AllenBradleyImportWizard wizard = new AllenBradleyImportWizard(null);
    wizard.setFilesystem(filesystem);
    File defaultDrvStore = AllenBradleyActivator.getDefault().getFile(AllenBradleyActivator.getDefault().getBundle(),
