...
public class OPCUAModuleDPEditorInput implements IEditorInput {
	...
	private OPCUAServerModuleDPsModelNode node = null;
	...
	public boolean equals(Object obj) {
		...
		OPCUAModuleDPEditorInput iobj = (OPCUAModuleDPEditorInput) obj;
		return (this.getServerName() + " - " + this.getDriverName())
				.compareTo(iobj.getServerName() + " - " + iobj.getDriverName()) == 0;
	}

	public OPCUAServerModuleDPsModelNode getNode() {
		return node;
	}

	public void setNode(OPCUAServerModuleDPsModelNode node) {
		this.node = node;
	}
