...
public class OPCUAReportPathEditorInput implements IPathEditorInput {
	private IPath fPath;
	private String projectName;

	public OPCUAReportPathEditorInput(IPath path) {
		if (path == null) {
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof OPCUAReportPathEditorInput))
			return false;
		OPCUAReportPathEditorInput other = (OPCUAReportPathEditorInput) obj;
