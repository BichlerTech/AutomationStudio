...
public class OPCUAEcmaScriptEditorInput extends FileStoreEditorInput implements IStorageEditorInput {
	...
	public OPCUAEcmaScriptEditorInput(CometLocaleFile fileStore) {
		super(fileStore);
	...
	public IStorage getStorage() throws CoreException {
		...
		return new IStorage() {
			...
			public String getName() {
				return fileStore.getName() + " - " + interval;
			}
