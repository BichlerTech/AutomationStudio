...
public class OPCUAServerDriverDPsModelNode extends OPCUAServerDriverModelNode implements IValidationNode {
	@Override
	public void nodeDBLClicked() {
		...
		Command openDriverDPCmd = commandService.getCommand("com.bichler.astudio.commands.openopcuadpconfig");
