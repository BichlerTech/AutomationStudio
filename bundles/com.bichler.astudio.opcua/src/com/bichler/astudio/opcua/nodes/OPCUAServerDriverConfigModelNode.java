...
public class OPCUAServerDriverConfigModelNode extends OPCUAServerDriverModelNode implements IValidationNode {
	@Override
	public void nodeDBLClicked() {
		...
		Command openDriverDPCmd = commandService.getCommand("com.bichler.astudio.commands.openopcuadriverconfig");
