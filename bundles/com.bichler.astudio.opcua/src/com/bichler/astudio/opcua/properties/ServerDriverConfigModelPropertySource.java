...
public class ServerDriverConfigModelPropertySource extends AbstractOPCPropertySource {
	...
	public ServerDriverConfigModelPropertySource(StudioModelNode adapter) {
		super(adapter);
	}
	...
	@Override
	public OPCUAServerDriverConfigModelNode getAdapter() {
		return (OPCUAServerDriverConfigModelNode) super.getAdapter();
	}
}
