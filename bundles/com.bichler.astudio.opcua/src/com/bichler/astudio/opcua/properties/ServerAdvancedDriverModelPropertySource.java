...
public class ServerAdvancedDriverModelPropertySource extends AbstractOPCPropertySource {
	...
	public ServerAdvancedDriverModelPropertySource(StudioModelNode adapter) {
		super(adapter);
	}
	...
	@Override
	public OPCUAAdvancedServerDriversModelNode getAdapter() {
		return (OPCUAAdvancedServerDriversModelNode) super.getAdapter();
	}
}
