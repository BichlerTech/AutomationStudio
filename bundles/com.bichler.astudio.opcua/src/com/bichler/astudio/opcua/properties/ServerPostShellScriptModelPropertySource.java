...
public class ServerPostShellScriptModelPropertySource extends AbstractOPCPropertySource {
	private static final String PROPERTY_DESCRIPTION = "p_desc";

	public ServerPostShellScriptModelPropertySource(StudioModelNode adapter) {
		super(adapter);
	}
	...
	@Override
	public OPCUAServerPostShellScriptModelNode getAdapter() {
		return (OPCUAServerPostShellScriptModelNode) super.getAdapter();
	}
}
