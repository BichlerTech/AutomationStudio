...
public class ServerEcmaSingleScriptsModelPropertySource extends AbstractOPCPropertySource {
	private static final String PROPERTY_DESCRIPTION = "p_desc";

	public ServerEcmaSingleScriptsModelPropertySource(StudioModelNode adapter) {
		super(adapter);
	}
	...
	@Override
	public OPCUAServerEcmaSingleScriptsModelNode getAdapter() {
		return (OPCUAServerEcmaSingleScriptsModelNode) super.getAdapter();
	}
}
