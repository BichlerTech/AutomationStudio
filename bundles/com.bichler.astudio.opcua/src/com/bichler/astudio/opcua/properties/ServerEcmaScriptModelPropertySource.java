...
public class ServerEcmaScriptModelPropertySource extends AbstractOPCPropertySource {
	private static final String PROPERTY_DESCRIPTION = "p_desc";

	public ServerEcmaScriptModelPropertySource(StudioModelNode adapter) {
		super(adapter);
	}
	...
	@Override
	public OPCUAServerEcmaScriptModelNode getAdapter() {
		return (OPCUAServerEcmaScriptModelNode) super.getAdapter();
	}
}
