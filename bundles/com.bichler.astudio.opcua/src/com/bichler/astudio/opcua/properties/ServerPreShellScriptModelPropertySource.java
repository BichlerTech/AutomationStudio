...
public class ServerPreShellScriptModelPropertySource extends AbstractOPCPropertySource {
	private static final String PROPERTY_DESCRIPTION = "p_desc";

	public ServerPreShellScriptModelPropertySource(StudioModelNode adapter) {
		super(adapter);
	}
	...
	@Override
	public OPCUAServerPreShellScriptModelNode getAdapter() {
		return (OPCUAServerPreShellScriptModelNode) super.getAdapter();
	}
}
