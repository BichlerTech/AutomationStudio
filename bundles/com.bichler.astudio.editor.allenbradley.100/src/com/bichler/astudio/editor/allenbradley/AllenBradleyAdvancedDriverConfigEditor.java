...
public class AllenBradleyAdvancedDriverConfigEditor extends AbstractOPCConfigDriverViewLinkEditorPart
		implements INamespaceTableChange {
	public static final String ID = "com.bichler.astudio.opcua.editor.AllenBradleyAdvancedDriverConfigEditor"; //$NON-NLS-1$
	...
	public AllenBradleyAdvancedDriverConfigEditor() {
	}
	...
	public void onFocusRemoteView() {
		...
		// Command openDriverModelCmd = commandService
		//		.getCommand("com.bichler.astudio.editor.opendrivermodel." + getEditorInput().getDriverType());
