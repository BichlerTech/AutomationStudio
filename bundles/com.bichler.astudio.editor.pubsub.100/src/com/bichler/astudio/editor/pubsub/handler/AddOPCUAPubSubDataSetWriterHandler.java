...
public class AddOPCUAPubSubDataSetWriterHandler extends AbstractOPCCreateDriverModel
{
  public static final String ID = "com.bichler.astudio.editor.pubsub.1.0.0.addpubsubdatasetwriter";
