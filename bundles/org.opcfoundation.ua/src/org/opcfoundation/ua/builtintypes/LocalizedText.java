 ...
 * The &lt;country/region&gt; component is always preceded by a hyphen. The
 * format of the LocaleId string is shown below:
 * 
 * &lt;language&gt;[-&lt;country/region&gt;], where &lt;language&gt; is the two
 * letter ISO 639 code for a language, &lt;country/region&gt; is the two letter
 * ISO 3166 code for the country/region.
 * 
 * The rules for constructing LocaleIds defined by RFC 3066 are restricted for
 * OPC UA as follows: d) OPC UA permits only zero or one &lt;country/region&gt;
 * component to follow the &lt;language&gt; component, e) OPC UA also permits
 * the "-CHS" and "-CHT" three-letter &lt;country/region&gt; codes for
 * "Simplified" and "Traditional" Chinese locales. f) OPC UA also allows the use
 * of other &lt;country/region&gt; codes as deemed necessary by the client or
 * the server.
 * 
 * Example: English en English (US) en-US German de German (Germany) de-DE
 * German (Austrian) de-AT
 * 
 * See Country Codes
 * <code>http://www.iso.org/iso/english_country_names_and_code_elements</code>
 * See Language Codes
 * <code>http://www.loc.gov/standards/iso639-2/php/English_list.php</code>
 * 
...
public final class LocalizedText {
	...
	public static Locale toLocale(String localeId) {
		...
		if (!m.matches())
			return NO_LOCALE;
		// throw new IllegalArgumentException("Invalid locale \""+localeId+"\""); //
		// changes made 3.6. TODO
	...
	@Override
	public int hashCode() {
		return ObjectUtils.hashCode(text) + 3 * ObjectUtils.hashCode(locale);
	}
	...
	public boolean equals(Object obj) {
		...
		return ObjectUtils.objectEquals(text, other.text) && ObjectUtils.objectEquals(locale, other.locale);
	}
