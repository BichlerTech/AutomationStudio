...
/**
 * Unsigned Integer represents an integer number value between 0 .. and
 * 0xFFFFFFFF.
 * <p>
 * There is a static instance for values between 0..1023 which can be accessed
 * using static methods {@link UnsignedInteger#valueOf(long)} or
 * {@link UnsignedInteger#getFromBits(int)}
 * <p>
 * This class is immutable - once it has been constructed its value cannot be
 * changed.
 * <p>
 * To use int as backend use {@link UnsignedInteger#toIntBits()} and
 * {@link UnsignedInteger#getFromBits(int)}.
 */
public final class UnsignedInteger extends Number implements Comparable<Number> {
	...
	/**
	 * Parses {@link UnsignedInteger} from String. Behaves same as
	 * {@link #parseUnsignedInteger(String)}.
	 */
	...
	/**
	 * Parses {@link UnsignedInteger} from String. Behaves same as
	 * {@link #parseUnsignedInteger(String, int)}.
	 */
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj.getClass().equals(UnsignedInteger.class)))
			return false;
	 ...
	 *                                            in the range of UnsignedInteger
	 */
	public static UnsignedInteger parseUnsignedInteger(String s, int radix)
			throws NumberFormatException, IllegalArgumentException {
