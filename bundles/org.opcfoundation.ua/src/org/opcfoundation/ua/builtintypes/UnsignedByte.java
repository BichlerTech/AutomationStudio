...
public final class UnsignedByte extends Number implements Comparable<UnsignedByte> {
	...
	/**
	 * Parses {@link UnsignedByte} from String. Behaves the same as
	 * {@link #parseUnsignedByte(String)}.
	 */
	...
	/**
	 * Parses {@link UnsignedByte} from String. Behaves the same as
	 * {@link #parseUnsignedByte(String, int)}.
	 */
	...
	public UnsignedByte(String valueString) throws IllegalArgumentException {
		...
		if ((_value < UnsignedByte.MIN_VALUE.getValue()) || (_value > UnsignedByte.MAX_VALUE.getValue())) {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj.getClass().equals(UnsignedByte.class)))
			return false;
