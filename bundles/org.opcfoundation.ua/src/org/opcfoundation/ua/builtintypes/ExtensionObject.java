...
/**
 * Extension object contains a {@link Structure} which is either XML or binary
 * encoded.
 */
public class ExtensionObject {
	 ...
	 * @param encodingType the requested encoding type either
	 *                     QualifiedName.DEFAULT_BINARY_ENCODING or
	 *                     QualifiedName.DEFAULT_XML_ENCODING
	 * @param serializer   the serializer to use (default is
	 *                     {@link StackUtils#getDefaultSerializer()})
	 * @return the encodeable as an ExtensionObject
	 * @throws org.opcfoundation.ua.encoding.EncodingException if the encodingType
	 *                                                         is unsupported or the
	 *                                                         encoding fails
	 * @param ctx a {@link org.opcfoundation.ua.encoding.EncoderContext} object.
	 * @deprecated use {@link #encode(Structure, QualifiedName, EncoderContext)}
	 *             with the serializer already set in the context. This method will
	 *             take a defensive copy of the given encoder context and set the
	 *             serializer directly to it. If the given serializer is null, the
	 *             given context is used directly.
	 */
	@Deprecated
	public static ExtensionObject encode(Structure encodeable, QualifiedName encodingType,
			IEncodeableSerializer serializer, EncoderContext ctx) throws EncodingException {
		if (encodeable == null)
			return null;
	 ...
	 * @param ctx a {@link org.opcfoundation.ua.encoding.EncoderContext} object.
	 */
	public static ExtensionObject encode(Structure encodeable, QualifiedName encodingType, EncoderContext ctx)
			throws EncodingException {
		return encode(encodeable, encodingType, StackUtils.getDefaultSerializer(), ctx);
	}

	/**
	 * Create extension object by encoding an encodeable to a binary format using
	 * the serializer that is set to the given context.
	 *
	 ...
	 * @param ctx a {@link org.opcfoundation.ua.encoding.EncoderContext} object.
	 */
	public static ExtensionObject binaryEncode(Structure encodeable, EncoderContext ctx) throws EncodingException {
	 ...
	 * @throws org.opcfoundation.ua.encoding.EncodingException on encoding problem
	 * @param ctx a {@link org.opcfoundation.ua.encoding.EncoderContext} object.
	 * @deprecated use {@link #binaryEncode(Structure, EncoderContext)} with the
	 *             serializer already set in the context. This method will take a
	 *             defensive copy of the given encoder context and set the
	 *             serializer directly to it. If the given serializer is null, the
	 *             given context is used directly.
	 */
	@Deprecated
	public static ExtensionObject binaryEncode(final Structure encodeable, final IEncodeableSerializer serializer,
			final EncoderContext ctx) throws EncodingException {
	...
	/**
	 * Create extension object by encoding an encodeable to xml format using the
	 * default serializer
	 *
	 * @param encodeable encodeable
	 ...
	 *                                                         not supported.
	 */
	public static ExtensionObject xmlEncode(Structure encodeable) throws EncodingException {
		throw new EncodingException(StatusCodes.Bad_DataEncodingUnsupported);
	}
	 ...
	 *               object.
	 * @param object an array of byte.
	 * @deprecated use {@link #ExtensionObject(ExpandedNodeId, ByteString)} instead.
	 *             This method will convert the given byte[] to ByteString.
	 */
	@Deprecated
...
//		this.encodeType = EncodeType.Xml;
	...
	/**
	 * Returns the type of the raw data returned by {@link #getObject()}. Returns
	 * null if this {@link ExtensionObject} already contains a {@link Structure}.
	 */
	...
	/**
	 * Get the object within this {@link ExtensionObject}. Can either be an already
	 * decoded Structure, raw encoded format as either {@link ByteString} or
	 * {@link XmlElement}.
	 */
	...
	/**
	 * <p>
	 * Getter for the field <code>typeId</code>.
	 * </p>
	 *
	...
	public <T extends IEncodeable> T decode(IEncodeableSerializer serializer, EncoderContext ctx,
			NamespaceTable namespaceTable) throws DecodingException {
		if (object == null) {
	...
	/**
	 * Attempts to decode the extension object using the default serializer of the
	 * stack.
	 *
	 * @param <T> type
	 * @param ctx context
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T extends IEncodeable> T decode(EncoderContext ctx, NamespaceTable namespaceTable)
	...
	/**
	 * Returns true, if the {@link #getObject()} is encoded value. Null is
	 * considered to be encoded value.
	 * 
