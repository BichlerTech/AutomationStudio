...
public class ServiceResult {
	...
	/**
	 * Create service result with stack trace from an exception. If exception is
	 * ServiceResultException, use its reported status code, if not the error code
	 * will be set to Bad_UnexpectedError.
	 *
	 * @param t throwable
	...
	public static ServiceResult toServiceResult(Throwable t) {
		...
		res.setCode(t instanceof ServiceResultException ? ((ServiceResultException) t).getStatusCode()
	 ...
	 * </p>
	 *
	 * @param code a {@link org.opcfoundation.ua.builtintypes.UnsignedInteger}
	 *             object.
	 * @param e    a {@link java.lang.Throwable} object.
	 */
	...
	/**
	 * <p>
	 * Getter for the field <code>innerResult</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Setter for the field <code>innerResult</code>.
	 * </p>
	 *
	 * @param innerResult a {@link org.opcfoundation.ua.builtintypes.ServiceResult}
	 *                    object.
	 */
