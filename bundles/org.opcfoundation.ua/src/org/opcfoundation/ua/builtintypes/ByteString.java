...
/**
 * This primitive DataType specifies a ByteString, similar as String but for
 * bytes. Class is final because it is an immutable value object.
 * 
 * Also the constructor is private to avoid situations where the given value
 * would be null, now the static factory methods returns null if given
 * ByteString Null equivalent byte[].
 */
public final class ByteString implements Comparable<ByteString> {

	/**
	 * A null-safe way to convert ByteString to byte[]. The given array is copied
	 * for value.
	 * 
	...
	/**
	 * Create new ByteString from an array of bytes. NOTE! the given array is
	 * copied.
	 * 
