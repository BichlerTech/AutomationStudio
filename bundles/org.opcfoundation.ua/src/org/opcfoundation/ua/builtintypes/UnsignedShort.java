...
public final class UnsignedShort extends Number implements Comparable<UnsignedShort> {
	...
	/**
	 * Parses {@link UnsignedShort} from String. Behaves the same as
	 * {@link #parseUnsignedShort(String)}.
	 */
	...
	/**
	 * Parses {@link UnsignedShort} from String. Behaves the same as
	 * {@link #parseUnsignedShort(String, int)}.
	 */
	 ...
	 *                                            in the range of UnsignedShort
	 */
	public static UnsignedShort parseUnsignedShort(String s, int radix)
