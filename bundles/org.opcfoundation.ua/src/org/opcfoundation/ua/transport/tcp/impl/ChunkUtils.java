...
public class ChunkUtils {
	 ...
	 */
	public static String getAbortMessage(ByteBuffer chunk) throws ServiceResultException {
		chunk.position(8);
	 ...
	 * @throws org.opcfoundation.ua.common.ServiceResultException if any.
	 */
	public static String getSecurityPolicyUri(ByteBuffer chunk) throws ServiceResultException {
		chunk.position(12);
		return getString(chunk);
	}
	 ...
	 * @throws org.opcfoundation.ua.common.ServiceResultException if any.
	 */
	public static String getString(ByteBuffer chunk) throws ServiceResultException {
