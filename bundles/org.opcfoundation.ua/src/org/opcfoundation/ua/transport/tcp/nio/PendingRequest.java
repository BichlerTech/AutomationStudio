...
public class PendingRequest extends EndpointServiceRequest<ServiceRequest, ServiceResponse> {
	 ...
	 *
	 * @param channel        a
	 *                       {@link org.opcfoundation.ua.transport.tcp.nio.OpcTcpServerSecureChannel}
	 *                       object.
	 * @param endpoint       a {@link org.opcfoundation.ua.transport.Endpoint}
	 *                       object.
	 * @param server         a {@link org.opcfoundation.ua.application.Server}
	 *                       object.
	 ...
	 *                       object.
	 */
	public PendingRequest(OpcTcpServerSecureChannel channel, Endpoint endpoint, Server server, int requestId,
	...
	public void sendResponse(AsyncWrite response) {
		...
		channel.connection.sendSecureMessage(response, channel.getActiveSecurityToken(), requestId,
				TcpMessageType.MESSAGE, channel.sendSequenceNumber);
	}
	...
	public SecurityMode getSecurityMode() {
		// For opc.tcp each securechannel is unique and can represent client selection
		// of the mode
