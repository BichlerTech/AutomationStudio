 ...
 *
 */
public abstract class AbstractServerConnection extends AbstractState<CloseableObjectState, ServiceResultException>
	 ...
	 *
	 * @param msg                   a
	 *                              {@link org.opcfoundation.ua.transport.AsyncWrite}
	 *                              object.
	 * @param securityConfiguration a
	 *                              {@link org.opcfoundation.ua.transport.security.SecurityConfiguration}
	 *                              object.
	 * @param secureChannelId       a int.
	 * @param requestNumber         a int.
	 * @param sendSequenceNumber    a
	 *                              {@link java.util.concurrent.atomic.AtomicInteger}
	 *                              object.
	 * @return a int.
	 * @throws org.opcfoundation.ua.common.ServiceResultException if any.
	 */
	protected abstract int sendAsymmSecureMessage(final AsyncWrite msg,
			final SecurityConfiguration securityConfiguration, int secureChannelId, int requestNumber,
			AtomicInteger sendSequenceNumber) throws ServiceResultException;
	 ...
	 * </p>
	 *
	 * @param msg                a {@link org.opcfoundation.ua.transport.AsyncWrite}
	 *                           object.
	 * @param token              a
	 *                           {@link org.opcfoundation.ua.transport.tcp.impl.SecurityToken}
	 *                           object.
	 * @param requestId          a int.
	 * @param messageType        a int.
	 * @param sendSequenceNumber a {@link java.util.concurrent.atomic.AtomicInteger}
	 *                           object.
	 */
	protected abstract void sendSecureMessage(final AsyncWrite msg, final SecurityToken token, final int requestId,
	 ...
	 * </p>
	 *
	 * @param errorCode a {@link org.opcfoundation.ua.builtintypes.UnsignedInteger}
	 *                  object.
	 */
	...
	/**
	 * Send a notification to listeners that a secure channel has been attached to
	 * (opened in) the connection.
	 *
	...
	/**
	 * Send a notification the listeners that a secure channel has been detached
	 * from the connection.
	 *
	 * @param c a {@link org.opcfoundation.ua.transport.ServerSecureChannel} object.
	 */
	 ...
	 *
	 * @param listener a
	 *                 {@link org.opcfoundation.ua.transport.tcp.nio.Channel.ChannelListener}
	 *                 object.
	 */
