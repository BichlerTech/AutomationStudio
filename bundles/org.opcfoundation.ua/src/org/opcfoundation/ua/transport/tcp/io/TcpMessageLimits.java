...
public class TcpMessageLimits {
	...
	/**
	 * The number of bytes required to specify the length of an encoding string or
	 * bytestring.
	 */
	public static final int StringLengthSize = 4;

	/** Sequence numbers may only rollover if they are larger than this value. */
	public static final UnsignedInteger MinSequenceNumber = UnsignedInteger
			.valueOf(UnsignedInteger.L_MAX_VALUE - UnsignedShort.L_MAX_VALUE);
	...
	/**
	 * How long a connection will remain in the server after it goes into a faulted
	 * state.
	 */
	...
	/**
	 * The minimum lifetime for a security token lasts before it needs to be
	 * renewed.
	 */
