...
public class SequenceNumber {
	...
	/**
	 * <p>
	 * Setter for the field <code>recvSequenceNumber</code>.
	 * </p>
	 *
	 * @param value a int.
	 */
	 ...
	 *
	 * Test passes if the value is one larger than previous value or if previous
	 * value is 4294966271 or larger.
	 *
	...
	/**
	 * Get the next send sequence number. Send sequence number wraps between
	 * 4294966271 and 4294967295 to a new value that is below 1024.
	 *
	...
	public int getNextSendSequencenumber() {
		...
		if (wraps)
			newValue = StackUtils.RANDOM.nextInt(1024);
