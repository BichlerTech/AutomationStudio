...
public class Acknowledge implements IEncodeable {
	...
	static {
		try {
			fields = new Field[] { Acknowledge.class.getDeclaredField("ProtocolVersion"),
	 ...
	 *                          object.
	 */
	public Acknowledge(UnsignedInteger protocolVersion, UnsignedInteger receiveBufferSize,
			UnsignedInteger sendBufferSize, UnsignedInteger maxMessageSize, UnsignedInteger maxChunkCount) {
