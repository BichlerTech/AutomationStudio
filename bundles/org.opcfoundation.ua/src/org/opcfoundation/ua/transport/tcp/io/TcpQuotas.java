...
public class TcpQuotas {
	...
	public static final TcpQuotas DEFAULT_CLIENT_QUOTA = new TcpQuotas(Integer.MAX_VALUE,
			TcpMessageLimits.MaxBufferSize, TcpMessageLimits.DefaultChannelLifetime,
			TcpMessageLimits.DefaultSecurityTokenLifeTime);
	/** Constant <code>DEFAULT_SERVER_QUOTA</code> */
	public static final TcpQuotas DEFAULT_SERVER_QUOTA = new TcpQuotas(Integer.MAX_VALUE,
			TcpMessageLimits.MaxBufferSize, TcpMessageLimits.DefaultChannelLifetime,
			TcpMessageLimits.DefaultSecurityTokenLifeTime);
	 ...
	 */
	public TcpQuotas(int maxMessageSize, int maxBufferSize, int channelLifetime, int securityTokenLifetime) {
