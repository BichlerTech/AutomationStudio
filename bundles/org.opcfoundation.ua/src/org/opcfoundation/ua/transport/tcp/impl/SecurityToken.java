...
public class SecurityToken {
	 ...
	 */
	public SecurityToken(SecurityConfiguration securityProfile, int secureChannelId, int tokenId, long creationTime,
			long lifetime, ByteString serverNonce, ByteString clientNonce) throws ServiceResultException {
	...
	/**
	 * Generates a Pseudo random sequence of bits using the P_SHA1 or P_SHA256
	 * alhorithm.
	 * 
	 * This function conforms with C#-implementation, so that keys returned from
	 * this function matches the C#-implementation keys.
	 * 
	 * @param byteString
	 * @param label
	 * @param byteString2
	 ...
	 */
	private byte[] PSHA(ByteString byteString, String label, ByteString byteString2, int offset, int length)
		...
		if (seed == null) {
			throw new ServiceResultException(StatusCodes.Bad_UnexpectedError,
					"The PSHA algorithm requires a non-null seed.");
		}
	...
	/**
	 * Return security token validity. Security token is still valid if it has
	 * expired up to 25% after its lifetime. (See Part 6, 5.5.2.1/3)
	 *
	...
	/**
	 * Return security token time to renew status. True if 75% of security tokens
	...
	/**
	 * Return security tokens expired status. Token is expired if its 100% of its
	 * life time has elapsed. Note, the token is valid for use until 125% of its
	...
	/**
	 * <p>
	 * Getter for the field <code>securityConfiguration</code>.
	 * </p>
	 *
	 * @return a
	 *         {@link org.opcfoundation.ua.transport.security.SecurityConfiguration}
	...
	/**
	 * <p>
	 * Getter for the field <code>localSigningKey</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Setter for the field <code>localSigningKey</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>localEncryptingKey</code>.
	 * </p>
	 *
	 * @return an array of byte.
	 */
	...
	/**
	 * <p>
	 * Setter for the field <code>localEncryptingKey</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>localInitializationVector</code>.
	 * </p>
	 *
	 * @return an array of byte.
	 */
	...
	/**
	 * <p>
	 * Setter for the field <code>localInitializationVector</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>remoteSigningKey</code>.
	 * </p>
	 *
	 * @return an array of byte.
	 */
	...
	/**
	 * <p>
	 * Setter for the field <code>remoteSigningKey</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>remoteEncryptingKey</code>.
	 * </p>
	 *
	 * @return an array of byte.
	 */
	...
	/**
	 * <p>
	 * Setter for the field <code>remoteEncryptingKey</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>remoteInitializationVector</code>.
	 * </p>
	 *
	 * @return an array of byte.
	 */
	...
	/**
	 * <p>
	 * Setter for the field <code>remoteInitializationVector</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>localNonce</code>.
	 * </p>
	 *
	 * @return an array of byte.
	 */
	...
	/**
	 * <p>
	 * Getter for the field <code>remoteNonce</code>.
	 * </p>
	 *
	 * @return an array of byte.
	 */
	...
	/**
	 * <p>
	 * Getter for the field <code>secureChannelId</code>.
	 * </p>
	 *
	 * @return a int.
	 */
	...
	/**
	 * <p>
	 * Getter for the field <code>tokenId</code>.
	 * </p>
	 *
	 * @return a int.
	 */
	...
	public String toString() {
		...
		return "SecurityToken(Id=" + tokenId + ", secureChannelId=" + secureChannelId + ", creationTime="
				+ DateFormat.getDateTimeInstance().format(cal.getTime()) + ", lifetime=" + lifetime + ")";
	}
