...
/**
 * Encodes messages to chunks. Returns an array of plaintexts whose content is
 * partially filled. Chunk size, padding and plaintext is written, but footer
 * and header is missing. ByteOrder is Little Endian.
 * <p>
...
public class MessageToChunks implements Callable<ByteBuffer[]> {
	 ...
	 * </p>
	 *
	 * @param msg          a {@link org.opcfoundation.ua.encoding.IEncodeable}
	 *                     object.
	 * @param ctx          a
	 *                     {@link org.opcfoundation.ua.transport.tcp.impl.TcpConnectionParameters}
	 *                     object.
	 * @param encoderCtx   a {@link org.opcfoundation.ua.encoding.EncoderContext}
	 *                     object.
	 * @param chunkFactory a
	 *                     {@link org.opcfoundation.ua.transport.tcp.impl.ChunkFactory}
	 *                     object.
	 * @param type         a
	 *                     {@link org.opcfoundation.ua.transport.tcp.nio.MessageType}
	 *                     object.
	 */
	public MessageToChunks(IEncodeable msg, TcpConnectionParameters ctx, EncoderContext encoderCtx,
			ChunkFactory chunkFactory, MessageType type) {
