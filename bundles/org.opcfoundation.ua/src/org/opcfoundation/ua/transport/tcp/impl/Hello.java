...
public class Hello implements IEncodeable {
	...
	static {
		try {
			fields = new Field[] { Hello.class.getDeclaredField("ProtocolVersion"),
					Hello.class.getDeclaredField("ReceiveBufferSize"), Hello.class.getDeclaredField("SendBufferSize"),
					Hello.class.getDeclaredField("MaxMessageSize"), Hello.class.getDeclaredField("MaxChunkCount"),
	 ...
	 * </p>
	 *
	 * @param protocolVersion   a
	 *                          {@link org.opcfoundation.ua.builtintypes.UnsignedInteger}
	 *                          object.
	 * @param receiveBufferSize a
	 *                          {@link org.opcfoundation.ua.builtintypes.UnsignedInteger}
	 *                          object.
	 * @param sendBufferSize    a
	 *                          {@link org.opcfoundation.ua.builtintypes.UnsignedInteger}
	 *                          object.
	 * @param maxMessageSize    a
	 *                          {@link org.opcfoundation.ua.builtintypes.UnsignedInteger}
	 *                          object.
	 * @param maxChunkCount     a
	 *                          {@link org.opcfoundation.ua.builtintypes.UnsignedInteger}
	 *                          object.
	 * @param endpointUrl       a {@link java.lang.String} object.
	 */
	public Hello(UnsignedInteger protocolVersion, UnsignedInteger receiveBufferSize, UnsignedInteger sendBufferSize,
			UnsignedInteger maxMessageSize, UnsignedInteger maxChunkCount, String endpointUrl) {
