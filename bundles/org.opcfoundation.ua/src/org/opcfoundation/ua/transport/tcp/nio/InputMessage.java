...
public interface InputMessage {
	...
	/**
	 * Get message type. One of the following: {@link TcpMessageType#OPEN} Open
	 * Channel async message {@link TcpMessageType#CLOSE} Close Channel async
	 * message {@link TcpMessageType#MESSAGE} Service Request, or
	 * {@link ErrorMessage}
	 *
	 * @return message type
	 */
	 ...
	 * Get security token
	 *
	 * @return {@link SecurityConfiguration} if async message, {@link SecurityToken}
	 *         is sync message
	 */
	Object getToken();
