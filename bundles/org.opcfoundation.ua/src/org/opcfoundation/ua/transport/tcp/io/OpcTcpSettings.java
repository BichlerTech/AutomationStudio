...
public class OpcTcpSettings implements Cloneable {
	...
	public enum Flag {
		/**
		 * In multithread mode, depending on implementation, channels encrypt and
		 * decrypt messages simultaneously in multiple threads.
		 * 
	...
	/**
	 * <p>
	 * Setter for the field <code>clientCertificate</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>certificateValidator</code>.
	 * </p>
	 *
	 * @return a
	...
	/**
	 * <p>
	 * Setter for the field <code>certificateValidator</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>privKey</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Setter for the field <code>privKey</code>.
	 * </p>
	 *
	 * @param privKey a {@link org.opcfoundation.ua.transport.security.PrivKey}
	 *                object.
	 */
	...
	/**
	 * Timeout for the initial handshake (Hello/Acknowledge exchange) after a socket
	...
	/**
	 * Get the timeout used to listen on reverse connections, in milliseconds. Use
	 * -1 to use the default of
	 * {@link TcpConnection#getDefaultReverseHelloAcceptTimeout()}. 0 is infinite.
	 */
	...
	/**
	 * Timeout for the initial socket connect operation, in milliseconds. NOTE! this
	 * value is passed to {@link Socket#connect(java.net.SocketAddress, int)}.
	 * However in practice the maximum timeout is determined by the Operating
	 * System. If this is -1, then
	 * {@link TcpConnection#getDefaultHandshakeTimeout()} is used.
	 */
	 ...
	 * </p>
	 *
	 * @param tcs a {@link org.opcfoundation.ua.transport.tcp.io.OpcTcpSettings}
	 *            object.
	 */
	public void readFrom(OpcTcpSettings tcs) {
		if (tcs.clientCertificate != null)
			clientCertificate = tcs.clientCertificate;
		if (tcs.certificateValidator != null)
			certificateValidator = tcs.certificateValidator;
		if (tcs.privKey != null)
			privKey = tcs.privKey;
		flags = tcs.flags;
