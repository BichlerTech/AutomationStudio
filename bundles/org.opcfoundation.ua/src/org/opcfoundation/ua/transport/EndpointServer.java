...
/**
 * EndpointServer is an object that binds to a network socket and offers hosting
 * for endpoints.
 *
...
public interface EndpointServer extends CloseableObject, ConnectionMonitor {
	 ...
	 * @return a
	 *         {@link org.opcfoundation.ua.transport.EndpointServer.EndpointHandle}
	 *         object.
	 */
	EndpointHandle bind(SocketAddress socketAddress, EndpointBinding endpointBinding) throws ServiceResultException;

	/**
	 * Binds a ReverseHello connection point. Server shall connect to the given
	 * addresstoConnect parameter per the specification 1.04 Part 6 7.1.3, assuming
	 * the target is a ReverseHello-aware port.
	 */
