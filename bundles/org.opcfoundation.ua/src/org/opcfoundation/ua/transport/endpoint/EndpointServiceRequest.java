 ...
 *
 * A service request to be processed by a server (as opposed to service request
 * queried by a client).
 * <p>
...
public abstract class EndpointServiceRequest<Request extends ServiceRequest, Response extends ServiceResponse> {
	...
	/**
	 * A SecurityMode. Only relevant when as part of the
	...
	/**
	 * Convert Throwable into an Service fault and send that to the client. NOTE!
	 * This is a convenience method that exposes stack trace to the client. Use with
	 * care!
	 *
