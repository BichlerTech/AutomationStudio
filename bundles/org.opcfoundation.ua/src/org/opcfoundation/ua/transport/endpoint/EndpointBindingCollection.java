...
public class EndpointBindingCollection {
	 ...
	 * </p>
	 *
	 * @param binding a {@link org.opcfoundation.ua.transport.EndpointBinding}
	 *                object.
	 */
...
//			throw new RuntimeException("Collection already contains the endpoint binding");
	 ...
	 * </p>
	 *
	 * @param endpointAddress a {@link org.opcfoundation.ua.transport.Endpoint}
	 *                        object.
	 * @return a {@link java.util.List} object.
	 */
	...
	public List<EndpointBinding> get(String endpointUrl) {
		...
		for (EndpointBinding b : bindings) {
			if (b.endpointAddress.getEndpointUrl().equals(endpointUrl))
				result.add(b);
		}
	 ...
	 * </p>
	 *
	 * @param endpointServer a {@link org.opcfoundation.ua.transport.EndpointServer}
	 *                       object.
	 * @return a {@link java.util.List} object.
	 */
	 ...
	 * </p>
	 *
	 * @param serviceServer a {@link org.opcfoundation.ua.application.Server}
	 *                      object.
	 * @return a {@link java.util.List} object.
	 */
	public List<EndpointBinding> get(Server serviceServer) {
		...
		for (EndpointBinding b : bindings) {
			if (b.serviceServer.equals(serviceServer))
				result.add(b);
		}
	 ...
	 * </p>
	 *
	 * @param endpointServer  a
	 *                        {@link org.opcfoundation.ua.transport.EndpointServer}
	 *                        object.
	 * @param endpointAddress a {@link org.opcfoundation.ua.transport.Endpoint}
	 *                        object.
	 * @return a {@link java.util.List} object.
	...
	public List<EndpointBinding> get(EndpointServer endpointServer, Endpoint endpointAddress) {
		...
		for (EndpointBinding b : bindings) {
			if (b.endpointAddress.equals(endpointAddress) && b.endpointServer.equals(endpointServer))
				result.add(b);
		}
	...
	public List<EndpointBinding> get(Endpoint endpointAddress, Server serviceServer) {
		...
		for (EndpointBinding b : bindings) {
			if (b.endpointAddress.equals(endpointAddress) && b.serviceServer.equals(serviceServer))
				result.add(b);
		}
	...
	public List<EndpointBinding> get(EndpointServer endpointServer, Server serviceServer) {
		...
		for (EndpointBinding b : bindings) {
			if (b.endpointServer.equals(endpointServer) && b.serviceServer.equals(serviceServer))
				result.add(b);
		}
	...
	public static List<Server> getServiceServers(List<EndpointBinding> bindingList) {
		...
		for (EndpointBinding binding : bindingList) {
			if (!result.contains(binding.serviceServer))
				result.add(binding.serviceServer);
		}
		return result;
	}
	...
	public static List<Endpoint> getEndpointAddresses(List<EndpointBinding> bindingList) {
		...
		for (EndpointBinding binding : bindingList) {
			if (!result.contains(binding.endpointAddress))
				result.add(binding.endpointAddress);
		}
		return result;
	}
	 ...
	 *
	 * @param listener a
	 *                 {@link org.opcfoundation.ua.transport.endpoint.EndpointBindingCollection.EndpointBindingListener}
	 *                 object.
	 */
