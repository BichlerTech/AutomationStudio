 ...
 *
 * Common mechanism: - Secure channel id - Security tokens - State and Error
 * State
 */
public abstract class AbstractServerSecureChannel extends AbstractState<CloseableObjectState, ServiceResultException>
	 ...
	 * </p>
	 *
	 * @return a {@link org.opcfoundation.ua.transport.tcp.impl.SecurityToken}
	 *         object.
	 */
	...
	public synchronized SecurityToken getLatestNonExpiredToken() {
		...
		for (SecurityToken t : tokens.values()) {
			...
			if (result == null)
				result = t;
			if (t.getCreationTime() > result.getCreationTime())
				result = t;
		}
		return result;
	}
