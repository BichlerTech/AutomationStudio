...
public class ScCryptoProvider implements CryptoProvider {
	...
	/**
	 * <p>
	 * Constructor for ScCryptoProvider.
	 * </p>
	 */
...
//		}
	...
	public byte[] signAsymm(PrivateKey senderPrivate, SecurityAlgorithm algorithm, byte[] dataToSign)
		...
		if (senderPrivate instanceof java.security.interfaces.RSAPrivateCrtKey) {
			...
			privKey = new RSAPrivateKey(privateKey.getModulus(), privateKey.getPublicExponent(),
			...
			throw new IllegalArgumentException(
					"Private Key is not RSAPrivateKey: " + senderPrivate.getClass().getName());
	...
	private AsymmetricBlockCipher getAsymmetricCipher(SecurityAlgorithm algorithm, RSAPublicKey publicKey)
			throws ServiceResultException {
		CipherParameters params = new RSAKeyParameters(false, publicKey.getModulus(), publicKey.getPublicExponent());
		// logger.info("Cipher: \nmodulus={}, \npublicExponent={}\n",
