...
public enum SecurityPolicy {
	...
	NONE(SecurityPolicyUri.URI_BINARY_NONE, null, null, null, null, null, null, 0, 0, 0, 1, 1024, 2048, 0),

	BASIC128RSA15(SecurityPolicyUri.URI_BINARY_BASIC128RSA15, SecurityAlgorithm.HmacSha1, // Symmetric signature
	...
	BASIC256(SecurityPolicyUri.URI_BINARY_BASIC256, SecurityAlgorithm.HmacSha1, // Symmetric signature
	...
	BASIC256SHA256(SecurityPolicyUri.URI_BINARY_BASIC256SHA256, SecurityAlgorithm.HmacSha256, // Symmetric signature
			SecurityAlgorithm.Aes256, // Symmetric encryption
	...
	AES128_SHA256_RSAOAEP(SecurityPolicyUri.URI_BINARY_AES128_SHA256_RSAOAEP, SecurityAlgorithm.HmacSha256, // Symmetric
																											// signature
			SecurityAlgorithm.Aes128, // Symmetric encryption
			SecurityAlgorithm.RsaSha256, // Asymmetric signature
			SecurityAlgorithm.KwRsaOaep, // Asymmetric keywrap
	...
	AES256_SHA256_RSAPSS(SecurityPolicyUri.URI_BINARY_AES256_SHA256_RSAPSS, SecurityAlgorithm.HmacSha256, // Symmetric
																											// signature
			SecurityAlgorithm.Aes256, // Symmetric encryption
	...
	/**
	 * Policies defined in OPC UA 1.01. Includes {@link #BASIC128RSA15} and
	 * {@link #BASIC256}. This set in unmodifiable.
	 */
	public static final Set<SecurityPolicy> ALL_SECURE_101 = Collections
			.unmodifiableSet(EnumSet.of(BASIC128RSA15, BASIC256));

	/**
	 * Policies defined in OPC UA 1.02. Includes {@link #BASIC128RSA15},
	 * {@link #BASIC256} and {@link #BASIC256SHA256}. This set in unmodifiable.
	 */
	public static final Set<SecurityPolicy> ALL_SECURE_102 = Collections
			.unmodifiableSet(EnumSet.of(BASIC128RSA15, BASIC256, BASIC256SHA256));

	/**
	 * Policies defined in OPC UA 1.03. Includes {@link #BASIC128RSA15},
	 * {@link #BASIC256} and {@link #BASIC256SHA256}. This set in unmodifiable.
	 */
	public static final Set<SecurityPolicy> ALL_SECURE_103 = Collections
			.unmodifiableSet(EnumSet.of(BASIC128RSA15, BASIC256, BASIC256SHA256)); // same as 1.02.

	/**
	 * Policies defined in OPC UA 1.04. Includes {@link #BASIC256SHA256},
	 * {@link #AES128_SHA256_RSAOAEP} and {@link #AES256_SHA256_RSAPSS}. This set in
	 * unmodifiable.
	 */
	public static final Set<SecurityPolicy> ALL_SECURE_104 = Collections
			.unmodifiableSet(EnumSet.of(BASIC256SHA256, AES128_SHA256_RSAOAEP, AES256_SHA256_RSAPSS));
	 ...
	 *
	 * @param policy a
	 *               {@link org.opcfoundation.ua.transport.security.SecurityPolicy}
	 *               object.
	 */
	 ...
	 *                                                            unknown
	 */
	public static SecurityPolicy getSecurityPolicy(String securityPolicyUri) throws ServiceResultException {
	...
	SecurityPolicy(String policyUri, SecurityAlgorithm symmetricSignatureAlgorithmUri,
			SecurityAlgorithm symmetricEncryptionAlgorithmUri, SecurityAlgorithm asymmetricSignatureAlgorithmUri,
			SecurityAlgorithm asymmetricKeyWrapAlgorithmUri, SecurityAlgorithm asymmetricEncryptionAlgorithmUri,
			SecurityAlgorithm keyDerivationAlgorithmUri, int hmacHashSize, int signatureKeySize, int encryptionKeySize,
			int encryptionBlockSize, int minAsymmetricKeyLength, int maxAsymmetricKeyLength,
			int symmetricEncryptionNonceLength) {
	...
	/**
	 * <p>
	 * Getter for the field <code>asymmetricEncryptionAlgorithm</code>.
	 * </p>
	 *
	 * @return a {@link org.opcfoundation.ua.transport.security.SecurityAlgorithm}
	 *         object.
	 */
	...
	/**
	 * <p>
	 * Getter for the field <code>asymmetricKeyWrapAlgorithm</code>.
	 * </p>
	 *
	 * @return a {@link org.opcfoundation.ua.transport.security.SecurityAlgorithm}
	 *         object.
	...
	/**
	 * <p>
	 * Getter for the field <code>asymmetricSignatureAlgorithm</code>.
	 * </p>
	 *
	 * @return a {@link org.opcfoundation.ua.transport.security.SecurityAlgorithm}
	 *         object.
	...
	/**
	 * <p>
	 * Getter for the field <code>encodedPolicyUri</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>encryptionBlockSize</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>encryptionKeySize</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>keyDerivationAlgorithm</code>.
	 * </p>
	 *
	 * @return a {@link org.opcfoundation.ua.transport.security.SecurityAlgorithm}
	 *         object.
	...
	/**
	 * <p>
	 * Getter for the field <code>maxAsymmetricKeyLength</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>minAsymmetricKeyLength</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>policyUri</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>signatureKeySize</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>symmetricEncryptionAlgorithm</code>.
	 * </p>
	 *
	 * @return a {@link org.opcfoundation.ua.transport.security.SecurityAlgorithm}
	 *         object.
	...
	/**
	 * <p>
	 * Getter for the field <code>symmetricSignatureAlgorithm</code>.
	 * </p>
	 *
	 * @return a {@link org.opcfoundation.ua.transport.security.SecurityAlgorithm}
	 *         object.
	...
	/**
	 * <p>
	 * Getter for the field <code>symmetricSignatureSize</code>.
	 * </p>
	 *
	...
	public boolean isUsableWith(Cert cert) {
		...
		return keySize >= minAsymmetricKeyLength && keySize <= maxAsymmetricKeyLength;
	}
