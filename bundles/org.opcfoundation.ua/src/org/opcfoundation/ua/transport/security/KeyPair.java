...
public final class KeyPair {
	 ...
	 */
	public static KeyPair load(URL certificateFile, URL privateKeyFile, String privateKeyPassword) throws IOException,
	 ...
	 * @throws java.security.UnrecoverableKeyException if any.
	 */
	public static KeyPair load(File certificateFile, File privateKeyFile, String privateKeyPassword) throws IOException,
			UnrecoverableKeyException, NoSuchAlgorithmException, CertificateException, KeyStoreException {
		Cert cert = Cert.load(certificateFile);
		PrivKey privKey = PrivKey.loadFromKeyStore(privateKeyFile, privateKeyPassword);
		return new KeyPair(cert, privKey);
	 ...
	 *                    object.
	 * @param privateKey  a {@link org.opcfoundation.ua.transport.security.PrivKey}
	 *                    object.
	 */
	...
	/**
	 * <p>
	 * Getter for the field <code>certificate</code>.
	 * </p>
	 *
