...
public enum SecurityAlgorithm {
	...
	// PubSub algorithms
	Aes128Ctr(AlgorithmType.SymmetricEncryption, "http://opcfoundation.org/ua/security/aes128-ctr", "AES/CTR/NoPadding",
			128),
	Aes256Ctr(AlgorithmType.SymmetricEncryption, "http://opcfoundation.org/ua/security/aes256-ctr", "AES/CTR/NoPadding",
			256),

	// Asymmetric signature
	RsaSha1(AlgorithmType.AsymmetricSignature, "http://www.w3.org/2000/09/xmldsig#rsa-sha1", "SHA1withRSA", 160),
	RsaSha256(AlgorithmType.AsymmetricSignature, "http://www.w3.org/2001/04/xmldsig-more#rsa-sha256", "SHA256withRSA",
			256),
	RsaPssSha256(AlgorithmType.AsymmetricSignature, "http://opcfoundation.org/UA/security/rsa-pss-sha2-256",
			"SHA256withRSAandMGF1", 256),

	// Asymmetric encryption
	Rsa15(AlgorithmType.AsymmetricEncryption, "http://www.w3.org/2001/04/xmlenc#rsa-1_5", "RSA/NONE/PKCS1Padding", 0),
	RsaOaep(AlgorithmType.AsymmetricEncryption, "http://www.w3.org/2001/04/xmlenc#rsa-oaep",
			"RSA/NONE/OAEPWithSHA1AndMGF1Padding", 0),
	...
	RsaOaep256(AlgorithmType.AsymmetricEncryption, "http://www.w3.org/2001/04/xmlenc#rsa-oaep",
			"RSA/NONE/OAEPWithSHA-256AndMGF1Padding", 0),
	...
	PSha256(AlgorithmType.KeyDerivation, "http://docs.oasis-open.org/ws-sx/ws-secureconversation/200512/dk/p_sha256",
			"HmacSHA256", 0);

	public enum AlgorithmType {
		SymmetricSignature, SymmetricEncryption, AsymmetricSignature, AsymmetricEncryption, AsymmetricKeywrap,
		KeyDerivation
	}
	...
	/**
	 * <p>
	 * Getter for the field <code>padding</code>.
	 * </p>
	 *
	 * @return the padding
	 */
	...
	public String toString() {
		return "Algorithm URI=" + uri + " StandardName=" + standardName + " Transformation=" + transformation;
	}
	...
	/**
	 * <p>
	 * Getter for the field <code>transformation</code>.
	 * </p>
	 *
