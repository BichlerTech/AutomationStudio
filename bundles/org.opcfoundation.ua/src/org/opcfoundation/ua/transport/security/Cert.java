...
/**
 * Cert is a X509 certificate that contains a public key. The instance is valid
 * and encodedable. Wrapper to {@link java.security.cert.Certificate}.
 * <p>
...
public class Cert {
	...
	/**
	 * Create Certificate from encoded data, if the data contains more than one
	 * certificate, only the first one is read.
	 *
