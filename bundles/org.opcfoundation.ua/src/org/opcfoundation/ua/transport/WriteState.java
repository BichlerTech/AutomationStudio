 ...
 *
 * Initial states: Queued Final states: Flushed, Error
 *
 * The only allowed state transition paths: Queued -&gt; Writing -&gt; Flushed
 * Queued -&gt; Writing -&gt; Error
 *
 * @see AsyncWrite
 */
public enum WriteState {
	Ready, Queued, // Message has been placed in write queue
	Writing, // Message is being written
	Written, // Message has been written. As always with internet, transmission is not
				// quaranteed.
	Canceled, // Message was canceled
	Error; // Error by stack or abortion. (e.g. connection closed, aborted). See
			// getException().
