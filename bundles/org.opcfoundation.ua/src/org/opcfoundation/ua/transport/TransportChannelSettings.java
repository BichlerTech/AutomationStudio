...
public class TransportChannelSettings implements Cloneable {
	 ...
	 *                             object.
	 * @param clientCertificate    a
	 *                             {@link org.opcfoundation.ua.transport.security.Cert}
	 *                             object.
	 * @param privateKey           a
	 *                             {@link org.opcfoundation.ua.transport.security.PrivKey}
	 *                             object.
	 * @param certificateValidator a
	 *                             {@link org.opcfoundation.ua.transport.security.CertificateValidator}
	 *                             object.
	 * @param namespaceUris        (optional)
	 * @throws org.opcfoundation.ua.common.RuntimeServiceResultException if any.
	 */
	public TransportChannelSettings(EndpointDescription description, EndpointConfiguration configuration,
			Cert clientCertificate, PrivKey privateKey, CertificateValidator certificateValidator,
	 ...
	 *
	 * @param description   a {@link org.opcfoundation.ua.core.EndpointDescription}
	 *                      object.
	 * @param configuration a
	 *                      {@link org.opcfoundation.ua.core.EndpointConfiguration}
	 *                      object.
	 ...
	 *                         object.
	 * @param certValidator    a
	 *                         {@link org.opcfoundation.ua.transport.security.CertificateValidator}
	 *                         object.
	 * @param hostnameVerifier a
	 *                         {@link org.apache.http.conn.ssl.X509HostnameVerifier}
	 *                         object.
	 */
	public TransportChannelSettings(EndpointDescription description, EndpointConfiguration configuration,
			KeyPair keypair, CertificateValidator certValidator, X509HostnameVerifier hostnameVerifier)
	...
	public Cert getServerCertificate() {
		try {
			if (this.description != null && this.description.getServerCertificate() != null
					&& this.description.getServerCertificate().getLength() > 0) {
	...
	/**
	 * <p>
	 * Getter for the field <code>opctcpSettings</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Setter for the field <code>opctcpSettings</code>.
	 * </p>
	 *
	 * @param opctcpSettings a
	 *                       {@link org.opcfoundation.ua.transport.tcp.io.OpcTcpSettings}
	 *                       object.
	 */
	...
	/**
	 * <p>
	 * Getter for the field <code>httpsSettings</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Setter for the field <code>httpsSettings</code>.
	 * </p>
	 *
	 * @param httpsSettings a
	 *                      {@link org.opcfoundation.ua.transport.https.HttpsSettings}
	 *                      object.
	 */
	 ...
	 * </p>
	 *
	 * @param tcs a {@link org.opcfoundation.ua.transport.TransportChannelSettings}
	 *            object.
	 */
	public void readFrom(TransportChannelSettings tcs) {
		if (tcs.description != null)
			description = tcs.description.clone();
		if (tcs.configuration != null)
			configuration = tcs.configuration.clone();
		if (tcs.opctcpSettings != null)
			opctcpSettings.readFrom(tcs.opctcpSettings);
		if (tcs.httpsSettings != null)
			httpsSettings.readFrom(tcs.httpsSettings);
		if (tcs.namespaceUris != null)
			namespaceUris = tcs.namespaceUris;
	}
	...
	/**
	 * <p>
	 * Getter for the field <code>namespaceUris</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Setter for the field <code>namespaceUris</code>.
	 * </p>
	 *
	 * @param namespaceUris a {@link org.opcfoundation.ua.common.NamespaceTable}
	 *                      object.
	 */
