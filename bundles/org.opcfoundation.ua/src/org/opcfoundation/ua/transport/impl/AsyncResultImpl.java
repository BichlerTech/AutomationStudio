...
public class AsyncResultImpl<T> implements AsyncResult<T> {
	 ...
	 *
	 * @param error a {@link org.opcfoundation.ua.common.ServiceResultException}
	 *              object.
	 */
	...
	/**
	 * Set error, invokes any listener here and now. Note the listener may throw
	 * unexpected {@link RuntimeException}
	 *
	 * @param error a {@link org.opcfoundation.ua.common.ServiceResultException}
	 *              object.
	 * @throws java.lang.RuntimeException if any.
	 */
	public void setErrorSync(final ServiceResultException error) throws RuntimeException {
		synchronized (this) {
			if (isFinished())
				return;
			this.error = error;
	 ...
	 * @throws java.lang.RuntimeException if any.
	 */
	public void setResultSync(T result) throws RuntimeException {
		synchronized (this) {
			if (isFinished())
				return;
			this.result = result;
	...
	public T waitForResult() throws ServiceResultException {
		...
		if (error != null) {
			...
			// The error thread has originated from TcpConnection / Read - Switch the thread
			// in the stack trace to the current thread
	...
	/** {@inheritDoc} */
	@Override
	public T waitForResult(long timeout, TimeUnit unit) throws ServiceResultException {
		try {
