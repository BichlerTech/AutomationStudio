...
/**
 * UAConnection is a stateful object with four possible states {Closed, Opening,
 * Open, Closing}. A connection is transfers to open state after handshake
 * (Hello/Acknowledge). Closed state is final.
 */
public interface ServerConnection {
	 ...
	 *
	 * @param l a
	 *          {@link org.opcfoundation.ua.transport.ServerConnection.SecureChannelListener}
	 *          object.
	 */
