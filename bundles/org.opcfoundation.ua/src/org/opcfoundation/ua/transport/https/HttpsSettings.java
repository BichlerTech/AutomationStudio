...
public class HttpsSettings {
	...
	/**
	 * Verifies whether the target hostname matches the names stored inside the
	 * server's X.509 certificate, once the connection has been established. This
	 * verification can provide additional guarantees of authenticity of the server
	 * trust material.
	 */
	...
	/**
	 * Set keypair of a https application. This replaces a keyManager. Additional CA
	 * certifications can be attached.
	 * 
	...
	/**
	 * Set the trust manager for a https application. Trust manager validates peer's
	...
	/**
	 * Set an implementation of CertificateValidator as TrustManager. Trust manager
	 * validates peer's certificates and certificate issuers.
	 * 
