 ...
 * <p>
 *
 * If error recovery mode fails to re-establish new security token before the
...
public interface SecureChannel extends RequestChannel {
	...
	/**
	 * Open the secure channel with the endpoint identified by the URL. Once the
	 * channel is open if will be assigned a secure channel id.
	 *
	...
	/**
	 * Return the URL of the connection. This value is only available when the
	 * channel is in Open or Closing state, if not the return value is null.
	 *
	 ...
	 * attempt. The secure channel will eventually time out in the server.
	 * <p>
	 *
