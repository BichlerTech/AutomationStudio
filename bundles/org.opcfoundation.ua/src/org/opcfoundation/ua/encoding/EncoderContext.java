...
public class EncoderContext {
	private static EncoderContext defaultInstance = new EncoderContext(NamespaceTable.getInstance(), null,
	...
	public Object decode(ExtensionObject[] values, NamespaceTable namespaceTable) throws DecodingException {
		...
		for (int i = 0; i < n; i++) {
			...
			if (obj != null)
				newValue[i] = obj.decode(this, namespaceTable);
		}
		value = newValue;
		if (n > 0) {
			...
			if (valueClass != null)
				value = Arrays.copyOf(newValue, n, ((Structure[]) Array.newInstance(valueClass, 0)).getClass());
		}
		return value;
	}
	 ...
	 * </p>
	 *
	 * @param namespaceTable       a
	 *                             {@link org.opcfoundation.ua.common.NamespaceTable}
	 *                             object.
	 * @param serverTable          a {@link org.opcfoundation.ua.common.ServerTable}
	 *                             object.
	 * @param encodeableSerializer a
	 *                             {@link org.opcfoundation.ua.encoding.binary.IEncodeableSerializer}
	 *                             object.
	...
	/**
	 * <p>
	 * Getter for the field <code>maxMessageSize</code>.
	 * </p>
	 *
	 * @return a int.
	 */
	...
	/**
	 * <p>
	 * Setter for the field <code>maxMessageSize</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Setter for the field <code>namespaceTable</code>.
	 * </p>
	 *
	 * @param namespaceTable a {@link org.opcfoundation.ua.common.NamespaceTable}
	 *                       object.
	 ...
	 */
	public NodeId getEncodeableNodeId(Class<? extends IEncodeable> clazz, EncodeType type)
	...
	/**
	 * <p>
	 * Setter for the field <code>serverTable</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>encodeableSerializer</code>.
	 * </p>
	 *
	 * @return a {@link org.opcfoundation.ua.encoding.binary.IEncodeableSerializer}
	 *         object.
	 */
	...
	/**
	 * <p>
	 * Setter for the field <code>encodeableSerializer</code>.
	 * </p>
	 *
	 * @param encodeableSerializer a
	 *                             {@link org.opcfoundation.ua.encoding.binary.IEncodeableSerializer}
	...
	/**
	 * <p>
	 * Getter for the field <code>maxStringLength</code>.
	 * </p>
	 *
	 * @return a int.
	 */
	...
	/**
	 * <p>
	 * Setter for the field <code>maxStringLength</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>maxByteStringLength</code>.
	 * </p>
	 *
	 * @return a int.
	 */
	...
	/**
	 * <p>
	 * Setter for the field <code>maxByteStringLength</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>maxArrayLength</code>.
	 * </p>
	 *
	 * @return a int.
	 */
	...
	/**
	 * <p>
	 * Setter for the field <code>maxArrayLength</code>.
	 * </p>
	 *
	...
	/**
	 * Returns a new EncoderContext with same values. Serializer, NamespaceTable and
	 * ServerTable refers to same objects as this one.
	 */
