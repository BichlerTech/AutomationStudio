 ...
 *
 * There are two implementations; Reflection based
 * {@link EncodeableReflectionSerializer} and code-generate based
 * {@link EncodeableSerializer}.
 *
...
public interface IEncodeableSerializer {
	 ...
	 */
	IEncodeable getEncodeable(Class<? extends IEncodeable> clazz, IDecoder decoder) throws DecodingException;
	 ...
	 * @param clazz      a {@link java.lang.Class} object.
	 * @throws org.opcfoundation.ua.encoding.EncodingException if any.
	 * @deprecated this is no longer called by the stack, equivalent operations are
	 *             done though the
	 *             {@link #putEncodeable(Class, IEncodeable, IEncoder)}
	 */
	@Deprecated
