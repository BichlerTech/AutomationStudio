...
public enum NodeIdEncoding {
	...
	TwoByte((byte) 0x00, IdType.Numeric), FourByte((byte) 0x01, IdType.Numeric), Numeric((byte) 0x02, IdType.Numeric),
	String((byte) 0x03, IdType.String), Guid((byte) 0x04, IdType.Guid), ByteString((byte) 0x05, IdType.String);
	...
	/**
	 * <p>
	 * Getter for the field <code>bits</code>.
	 * </p>
	 *
	 * @return a byte.
	 */
