...
public final class EncodeableDesc {
	 ...
	 * @param fields   an array of
	 *                 {@link org.opcfoundation.ua.encoding.utils.EncodeableDesc.FieldInfo}
	 *                 objects.
	 * @param id       a {@link org.opcfoundation.ua.builtintypes.ExpandedNodeId}
	 *                 object.
	 * @param url      a {@link java.lang.String} object.
	 * @param binaryId a {@link org.opcfoundation.ua.builtintypes.ExpandedNodeId}
	 *                 object.
	 * @param xmlId    a {@link org.opcfoundation.ua.builtintypes.ExpandedNodeId}
	 *                 object.
	 */
	public EncodeableDesc(Class<? extends IEncodeable> clazz, FieldInfo[] fields, ExpandedNodeId id, String url,
	...
	public static EncodeableDesc readFromClass(Class<? extends IEncodeable> clazz, Field[] fields) {
		...
		return new EncodeableDesc(clazz, fieldInfos.toArray(new FieldInfo[fieldInfos.size()]), id, url, binaryId,
				xmlId);
	}
