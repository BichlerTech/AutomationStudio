...
public interface DefaultCertificateValidatorListener {
	...
	/**
	 * Handle certificate validation. You can use the event to define your custom
	 * handler to decide whether to trust or reject the certificate - permanently or
	 * just this time.
	 * <p>
	 ...
	 * isTrusted, isSignVerified, isValid are all false, you should normally accept
	 * the certificate.
	 * 
