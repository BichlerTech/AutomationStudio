...
/**
 * Certificate checks that the Validator performs. The values are used to define
 * which checks passed in the validator.
 *
...
public enum CertificateCheck {
	...
	/**
	 * is the certificate already defined as trusted, i.e. it is found from the
	 * TrustedDir or added to the validator using addTrustedCertificate
	 */
	...
	/**
	 * All tests that must pass, to accept the certificate. Defined as including
	 * EnumSet.of(Trusted, Validity, Signature, Uri)
	 */
