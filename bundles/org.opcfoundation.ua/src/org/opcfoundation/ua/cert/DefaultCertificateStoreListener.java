...
public interface DefaultCertificateStoreListener {
	...
	/**
	 * Called after {@link DefaultCertificateValidator} adds a Certificate to
	 * Rejected certificates
	 * 
	 * @param cert the added certificate
	 */
	public void onRejectedCertificateAdded(Cert cert);

	/**
	 * Called after {@link DefaultCertificateValidator} adds a Certificate Revoked
	 * List.
	 * 
