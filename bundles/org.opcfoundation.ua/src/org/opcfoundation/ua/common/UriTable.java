...
public class UriTable {
	 ...
	 * @return the URI with the index or null, if there is no such index
	 */
	 ...
	 *
	 * @param namespaceUri the URI of the namespace you are looking for
	...
	/**
	 * Add a new uri to the table. The uri will be added with a new index, unless it
	 * is in the table already, in which case the index is returned.
	 *
	 * @param uri The URI.
	 * @return a int.
	 */
	 ...
	 *
	 * @param index The new index (use -1 to automatically use the next unused
	 *              index)
	 * @param uri   The URI.
	 * @throws java.lang.IllegalArgumentException if the index is already in use
	 * @return a int.
	 */
	public synchronized int add(int index, String uri) {
		...
		if (index < 0)
			...
			throw new IllegalArgumentException("namespaceTable already has namespaceIndex " + index);
