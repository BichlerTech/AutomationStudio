...
/**
 * ServiceFaultException is an error that occurs in execution an operation. It
 * wraps {@link ServiceFault} into an exception.
 */
public class ServiceFaultException extends ServiceResultException {
	...
	public ServiceFaultException(ServiceFault serviceFault) {
		super(serviceFault.getResponseHeader() == null ? new StatusCode(StatusCodes.Bad_InternalError)
				: serviceFault.getResponseHeader().getServiceDiagnostics() == null
						? new StatusCode(StatusCodes.Bad_InternalError)
						: serviceFault.getResponseHeader().getServiceDiagnostics().getInnerStatusCode() == null
								? new StatusCode(StatusCodes.Bad_InternalError)
								: serviceFault.getResponseHeader().getServiceDiagnostics().getInnerStatusCode());
		this.serviceFault = serviceFault;
	}

	/**
	 * <p>
	 * Getter for the field <code>serviceFault</code>.
	 * </p>
	 *
