 ...
 *
 * Example: UABinding binding; binding.addConnectionListener(new
 * ConnectMonitor());
 *
...
public class DebugLogger implements ConnectListener, SecureChannelListener, StateListener<CloseableObjectState> {
	 ...
	 * @param oldState a {@link org.opcfoundation.ua.transport.CloseableObjectState}
	 *                 object.
	 * @param newState a {@link org.opcfoundation.ua.transport.CloseableObjectState}
	 *                 object.
	 */
	public void onStateTransition(IStatefulObject<CloseableObjectState, ?> sender, CloseableObjectState oldState,
