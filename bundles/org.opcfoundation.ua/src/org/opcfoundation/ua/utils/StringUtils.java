...
public class StringUtils {
	...
	/**
	 * @return the current system lineSeparator. Equals to
	 ...
	 * @param lineLength the number of characters per line. Use 0 or negative to
	 *                   omit the line breaks.
	 * @return a {@link java.lang.String} with {@link #lineSeparator()} added after
	 *         every lineLength characters.
	 */
	 ...
	 * </p>
	 * <p>
	 * Replaces all newline ("\n") and linefeed ("\r") characters in string with an
	 * empty string.
	 * 
	...
	/**
	 * Returns a string which has all whitespace characters removed from the given
	 * string.
	 */
