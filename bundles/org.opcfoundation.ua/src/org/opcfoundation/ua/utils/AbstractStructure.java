...
/**
 * A base class for Structure implementations. Main use case for extending this
 * class is the default implementation for .clone which does not throw
 * {@link CloneNotSupportedException} in .clone method signature as Structure as
 * of GH#65 extends Cloneable making it easier for classes extending this class
 * to just call super.clone without a try-catch block.
 */
