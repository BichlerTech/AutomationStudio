...
/**
 * SnapshotArray is synchronized list that provides copy-on-write-arraylist of
 * its contents.
 *
...
public class SnapshotArray<T> {
	...
	/**
	 * Get a snapshot of the contents. This method exposes an internal state which
	...
	/**
	 * Removes the first occurance of the item. If the item is added multiple times,
