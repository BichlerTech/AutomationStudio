...
public class AsyncServerSocket extends AbstractState<ServerSocketState, IOException> {
	 ...
	 * @param sel  a {@link org.opcfoundation.ua.utils.asyncsocket.AsyncSelector}
	 *             object.
	 * @throws java.nio.channels.ClosedChannelException if any.
	 */
	public AsyncServerSocket(ServerSocketChannel chan, Executor e, AsyncSelector sel) throws ClosedChannelException {
	 ...
	 */
	public AsyncServerSocket(ServerSocketChannel chan, Executor e) throws IOException {
		super(ServerSocketState.Ready, ServerSocketState.Error);
	 ...
	 */
	public /* synchronized */ AsyncServerSocket bind(SocketAddress addr, int backlog) throws IOException {
		ServerSocketState s = getState();
		if (s == ServerSocketState.Closed)
	 ...
	 * </p>
	 *
	 * @return a {@link org.opcfoundation.ua.utils.asyncsocket.AsyncServerSocket}
	 *         object.
	 */
	 ...
	 *
	 * @param listener a
	 *                 {@link org.opcfoundation.ua.utils.asyncsocket.AsyncServerSocket.ConnectListener}
	 *                 object.
	 */
