 ...
 * received (buffered, not read) and in AsyncSocketOutputStream the number of
 * bytes flushed to TCP Stack.
 * <p>
 * User can set event listeners or wait for a state change. E.g. // Block until
 * stream has buffered 1000 bytes inputStream.
 * createAlarm(inputStream.getPosition() + 1000, null).
 * waitForState(AlarmState.FINAL_STATES);
 *
 * @author Toni Kalajainen (toni.kalajainen@vtt.fi)
 */
public abstract class BufferMonitor extends AbstractState<BufferMonitorState, IOException>
	...
	/**
	 * <p>
	 * Getter for the field <code>triggerPos</code>.
	 * </p>
	 *
	 * @return a long.
	 */
