...
public class ListenableServerSocketChannel {
	...
	/**
	 * Wrap AsyncServerSocket over given ServerSocketChannel using given event
	 * worker thread and selector thread.
	 *
	...
	/**
	 * Wrap AsyncServerSocket over given ServerSocketChannel using given event
	 * worker thread and a new selector thread.
	 *
	 * @param channel       a {@link java.nio.channels.ServerSocketChannel} object.
	 * @param eventExecutor event executor or null for selector thread
	 ...
	 */
	public ListenableServerSocketChannel(ServerSocketChannel channel, Executor eventExecutor) throws IOException {
	...
	/**
	 * <p>
	 * Setter for the field <code>acceptableListener</code>.
	 * </p>
	 *
	 * @param listener a
	 *                 {@link org.opcfoundation.ua.utils.asyncsocket.ListenableServerSocketChannel.ServerSocketAcceptable}
	 *                 object.
	 */
	...
	/**
	 * <p>
	 * Getter for the field <code>acceptableListener</code>.
	 * </p>
	 *
	 * @return a
	 *         {@link org.opcfoundation.ua.utils.asyncsocket.ListenableServerSocketChannel.ServerSocketAcceptable}
	...
	/* synchronized */ int getInterestOps() {
		ServerSocketChannel c = channel.get();
		if (c == null || !c.isOpen() || !c.isRegistered())
			return 0;
		int ops = 0;
		if (acceptableListener != null && !acceptableHndPending)
	 ...
	 * <P>
	 * The <code>backlog</code> argument must be a positive value greater than 0. If
	 * the value passed if equal or less than 0, then the default value will be
	 * assumed.
	 *
	 * @param addr    address
	 * @param backlog backlog
	 * @throws java.lang.IllegalArgumentException if endpoint is a SocketAddress
	 *                                            subclass not supported by this
	 *                                            socket
	 * @throws IOException                        if error
	 */
	public /* synchronized */ void bind(SocketAddress addr, int backlog) throws IOException {
