...
public interface IBinaryWriteable {
	...
	/**
	 * Put n bytes from the remaining of the byte array. This operation moves the
	 * pointer in byte buffer.
	 *
	 * @param src a {@link java.nio.ByteBuffer} object.
	 * @throws java.io.IOException if any.
	 */
	void put(ByteBuffer src) throws IOException;

	/**
	 * Put n bytes from the remaining of the byte buffer. This operation moves the
	 * pointer in byte buffer.
	 *
	 * @param src    a {@link java.nio.ByteBuffer} object.
	 * @param length a int.
	 * @throws java.io.IOException if any.
	 */
	void put(ByteBuffer src, int length) throws IOException;
	 ...
	 * @throws java.io.IOException if any.
	 */
	void put(byte[] src, int offset, int length) throws IOException;
	 ...
	 * @throws java.io.IOException if any.
	 */
	void put(byte[] src) throws IOException;
