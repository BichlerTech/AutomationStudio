...
/**
 * Byte Queue is a LIFO queue of bytes. It uses {@link ByteBuffer}s as back-end
 * for data. There are two incremental memory pointers, read and write position.
 * Write position returns the number of bytes written to the queue, and read
 * bytes read.
 *
...
public class ByteQueue {
	...
	// [readChunk or null] [list = ByteBuffer, ByteBuffer, ByteBuffer, ...]
	// [writeChunk or null]
	 ...
	 */
	public void put(byte[] buf) throws BufferOverflowException {
	 ...
	 */
	public void put(byte[] buf, int off, int len) throws BufferOverflowException {
		if (buf == null) {
	...
	/**
	 * Offers a byte buffer object for the queue. The remaining bytes of buf are
	 * added to the queue. ByteQueue takes the ownership of buf.
	 *
	 ...
	 */
	public void get(byte[] buf) throws BufferUnderflowException {
	 ...
	 * @param length a int.
	 */
	public void get(ByteBuffer dst, int length) throws BufferUnderflowException {
	 ...
	 *
	 * This implementation copies memory only if the requested data is span over
	 * several ByteBuffers in the back-end.
	 *
	 * @param len a int.
	 * @return ByteBuffer containing read data
	 * @throws java.nio.BufferUnderflowException if any.
	 */
	public ByteBuffer get(int len) throws BufferUnderflowException {
		if (len < 0)
	 ...
	 * @throws java.nio.BufferUnderflowException if any.
	 */
	public void peek(byte[] buf, int off, int len) throws BufferUnderflowException {
		if (buf == null) {
			throw new NullPointerException();
		} else if (off < 0 || len < 0 || len > buf.length - off) {
			throw new IndexOutOfBoundsException();
	 ...
	 * @throws java.nio.BufferUnderflowException if any.
	 */
	public ByteBuffer peek(int len) throws BufferUnderflowException {
		if (len < 0)
			throw new IllegalArgumentException();
		if (len > remaining())
			throw new BufferUnderflowException();
	 ...
	 * @throws java.nio.BufferUnderflowException if any.
	 */
	public ByteBuffer[] peekChunks(int len) throws BufferUnderflowException {
		if (len < 0)
			throw new IllegalArgumentException();
		if (len > remaining())
			throw new BufferUnderflowException();
	...
	/**
	 * Count the number of chunks the given amount of bytes is spawn starting from
	 * the read pointer.
	 * 
...
//		skip((int) remaining());
	 ...
	 * @throws java.nio.BufferOverflowException if any.
	 */
	public void skip(int bytes) throws BufferOverflowException {
		if (bytes > remaining())
			throw new BufferOverflowException();
		while (bytes > 0) {
	...
	/**
	 * Expose the a byte buffer of backend. Moving the position of this byte buffer,
	 * moves the byte queue aswell.
	 *
	...
	/**
	 * Exposes internal bytebuffer of this object. Writing to this bytebuffer moves
	 * the pointer in this bytequeue aswell.
	 *
	...
	/**
	 * Flushes write chunk to internal buffer. Empties writeChunk (of bytes to
	 * write).
	 */
	...
	/**
	 * Set byte buffer constructor. The constructed buffers may be larger than
	 * requested but remaining bytes must be the requested amount.
	 *
	 * @param factory a
	 *                {@link org.opcfoundation.ua.utils.bytebuffer.ByteBufferFactory}
	 *                object.
	 */
