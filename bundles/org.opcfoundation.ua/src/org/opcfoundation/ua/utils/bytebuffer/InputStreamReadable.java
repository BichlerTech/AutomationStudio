...
public class InputStreamReadable implements IBinaryReadable {
	...
	public int getInt() throws IOException {
		if (order == ByteOrder.BIG_ENDIAN) {
			...
			return (_get()) | (_get() << 8) | (_get() << 16) | (_get() << 24);
		}
	}
	...
	public long getLong() throws IOException {
		if (order == ByteOrder.BIG_ENDIAN) {
			return (((long) _get()) << 56) | (((long) _get()) << 48) | (((long) _get()) << 40) | (((long) _get()) << 32)
					| (((long) _get()) << 24) | (((long) _get()) << 16) | (((long) _get()) << 8) | (((long) _get()));
		} else {
			return (((long) _get())) | (((long) _get()) << 8) | (((long) _get()) << 16) | (((long) _get()) << 24)
					| (((long) _get()) << 32) | (((long) _get()) << 40) | (((long) _get()) << 48)
					| (((long) _get()) << 56);
		}
	}
