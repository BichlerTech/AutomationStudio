...
public abstract class ByteBufferFactory {
	...
	public static final ByteBufferFactory DEFAULT_ENDIAN_HEAP_BYTEBUFFER_FACTORY = new ByteBufferFactory() {
		@Override
	...
	public static final ByteBufferFactory LITTLE_ENDIAN_HEAP_BYTEBUFFER_FACTORY = new ByteBufferFactory() {
		@Override
		public ByteBuffer allocate(int capacity) {
			ByteBuffer result = ByteBuffer.allocate(capacity);
	...
	public static final ByteBufferFactory BIG_ENDIAN_HEAP_BYTEBUFFER_FACTORY = new ByteBufferFactory() {
		@Override
		public ByteBuffer allocate(int capacity) {
			ByteBuffer result = ByteBuffer.allocate(capacity);
