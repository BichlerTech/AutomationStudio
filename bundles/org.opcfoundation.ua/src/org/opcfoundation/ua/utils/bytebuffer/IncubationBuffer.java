...
/**
 * Input stream with a sequence of ByteBuffers as backend. The data in
 * ByteBuffers in read in the order they are "incubated" The data becomes
 * available when the ByteBuffers are "hatched" Input stream blocks until data
 * becomes available.
 *
