...
/**
 * Discovery client enumerates endpoints. Current version supports only opc.tcp
 * protocol.
 */
public class EndpointUtil {
	...
	/**
	 * Select an endpoint that is supported by the stack and has the highest
	 * security level.
	 *
	 * @param endpoints an array of
	 *                  {@link org.opcfoundation.ua.core.EndpointDescription}
	...
	public static EndpointDescription select(EndpointDescription[] endpoints) throws ServiceResultException {
		...
		exit: {
			...
			if (tcpEndpoints.length == 0)
				break exit;
			// Sort endpoints by security level. The lowest level at the beginning, the
			// highest at the end of the array
	 ...
	 *                  {@link org.opcfoundation.ua.core.EndpointDescription}
	 *                  objects.
	 * @param mode      a {@link org.opcfoundation.ua.core.MessageSecurityMode}
	 *                  object.
	 ...
	 * <p>
	 * Selection uses the following precedence: 1) Protocol must be opc.tcp (as http
	 * is not implemented) 2) Security uses sign and encrypt 3) Select highest
	 * security level (determined by the server) 4) Prefer hostname over localhost
	 *
	 * @param endpoints an array of
	 *                  {@link org.opcfoundation.ua.core.EndpointDescription}
	 *                  objects.
	 ...
	 *
	 * @param ep       a {@link org.opcfoundation.ua.core.EndpointDescription}
	 *                 object.
	 ...
	 *
	 * @param enableIPv6 Set true to enable IPv6 addressing. Requires Java 7 or
	 *                   later on Windows platforms.
	 * @return all Internet addresses of this computer
	 * @throws java.net.SocketException if any.
	 */
	 ...
	 * @throws java.lang.IllegalArgumentException endpointUrl is problematic some
	 *                                            way
	 */
...
//				proto = parts[0].split(":")[0]; // // Use the proto parsed from URI, which should be fine, already
				...
				try {
					...
					for (InetAddress addr : addrs) {
						...
						if (!enableIPv6 && IPv6 && hasIPv6 && hasIPv4) {
							logger.warn("Binding of {} to {} was omited. (Workaround)", endpointUrl,
									addr.getHostAddress());
							continue;
						}
	 ...
	 * @param signatureData a {@link org.opcfoundation.ua.core.SignatureData}
	 *                      object.
	 * @return a {@link org.opcfoundation.ua.core.X509IdentityToken} object.
	 * @throws org.opcfoundation.ua.common.ServiceResultException if any.
	 */
	public static X509IdentityToken createX509IdentityToken(EndpointDescription ep, byte[] serverNonce,
			Cert certificate, PrivateKey key, SignatureData signatureData) throws ServiceResultException {
		...
		X509IdentityToken token = new X509IdentityToken(policy.getPolicyId(),
...
//		return new byte[] {(byte)(value>>24), (byte)(value>>16), (byte)(value>>8), (byte)(value)};
	 ...
	 * </p>
	 *
	 * @param userIdentityTokens an array of
	 *                           {@link org.opcfoundation.ua.core.UserTokenPolicy}
	 *                           objects.
	 * @return a boolean.
	 */
