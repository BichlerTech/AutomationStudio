...
public class NumericRange {
	 ...
	 *
	 * @param indexes the indexes to use for initializing the range. Each element is
	 ...
	 * <p>
	 * Returns false if the object is not indexable or if the numeric range is out
	 * of bounds.
	 *
	...
	/**
	 * Define the begin index of the range for the specified dimension. Note that
	 ...
	 * @throws org.opcfoundation.ua.common.ServiceResultException in case the range
	 *                                                            is not in proper
	 *                                                            format
	 */
	...
	/**
	 * Define the number of dimensions for the NumericRange. By default the range is
	 * 1-dimensional, but you can define a multidimensional range as well.
	 *
	 * @param dimensions the number of dimensions for the range; must be greater
	 *                   than 0
	 */
	...
	/**
	 * Check if the range is an empty range. Adds a null check, in addition to the
	 * standard {@link #isEmpty()} check.
	 *
