...
public class AttributesUtil {
	...
	// TODO Mikko added some attributeIds to this function..please check that those
	// are correct..the information has been taken from spec part 3 v. 1.01.13 from
	// chapter 5.9
	/**
	 * Tests if the attribute is valid for at least one of the node classes
	...
	public static boolean isValid(NodeClass nodeClass, UnsignedInteger attributeId) {
		...
		// NodeId,NodeClass,DisplayName&BrowseName are mandatory for all node
		// types..Description,UserWriteMask&EriteMask are optional for all nodeTypes
		...
		if (attributeId.equals(Attributes.Value) || attributeId.equals(Attributes.DataType)
				|| attributeId.equals(Attributes.ValueRank)) {
			return (ordinalNodeClass & (org.opcfoundation.ua.core.NodeClass.VariableType.ordinal()
					| org.opcfoundation.ua.core.NodeClass.Variable.ordinal())) != 0;

		}

		if (attributeId.equals(Attributes.IsAbstract)) {
			return (ordinalNodeClass & (org.opcfoundation.ua.core.NodeClass.VariableType.ordinal()
					| org.opcfoundation.ua.core.NodeClass.ObjectType.ordinal()
					| org.opcfoundation.ua.core.NodeClass.DataType.ordinal()
					| org.opcfoundation.ua.core.NodeClass.ReferenceType.ordinal())) != 0;
		}
		...
		if (attributeId.equals(Attributes.EventNotifier)) {
			return (ordinalNodeClass & (org.opcfoundation.ua.core.NodeClass.Object.ordinal()
					| org.opcfoundation.ua.core.NodeClass.View.ordinal())) != 0;
		}

		if (attributeId.equals(Attributes.AccessLevel) || attributeId.equals(Attributes.UserAccessLevel)
