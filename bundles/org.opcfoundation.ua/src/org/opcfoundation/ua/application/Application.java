...
public class Application {
	...
	private EncoderContext encoderContext = new EncoderContext(new NamespaceTable(), new ServerTable(),
	...
	/**
	 * <p>
	 * Getter for the field <code>applicationDescription</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>softwareCertificates</code>.
	 * </p>
	 *
	 * @return an array of
	 *         {@link org.opcfoundation.ua.core.SignedSoftwareCertificate} objects.
	 */
	 ...
	 * </p>
	 *
	 * @param cert a {@link org.opcfoundation.ua.core.SignedSoftwareCertificate}
	 *             object.
	 */
	...
	/**
	 * <p>
	 * Getter for the field <code>applicationInstanceCertificates</code>.
	 * </p>
	 *
	 * @return an array of {@link org.opcfoundation.ua.transport.security.KeyPair}
	 *         objects.
	 */
	 ...
	 * </p>
	 *
	 * @param applicationInstanceCertificate a
	...
	public KeyPair getApplicationInstanceCertificate(byte[] thumb) {
		...
		if (thumb != null) {
			...
			for (KeyPair cert : applicationInstanceCertificates) {
				byte[] encodedThumbprint = cert.getCertificate().getEncodedThumbprint();
				logger.debug("getApplicationInstanceCertificate: cert[{}]={}", i++,
						CryptoUtil.toHex(encodedThumbprint));
	...
	/**
	 * <p>
	 * Getter for the field <code>locales</code>.
	 * </p>
	 *
