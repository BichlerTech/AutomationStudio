 ...
 *
 * The plan is to create discovery server that supports various back-ends using
 * Java Naming and Directory Interface (JNDI). JNDI is extendable and out-of-box
 * it supports LDAP.
 *
