...
public class Session {
	...
	/**
	 * NodeId that contains SessionDiagnosticsInfo, see
	 * {@link SessionDiagnosticsDataType}
	 */
	NodeId diagnosticsInfo;
	/**
	 * Server assigned authentication token. It is passed in every request and
	 * response
	 */
	...
	/**
	 * Create new unactivated session channel. Session Channel will be wrapped over
	 * secure channel.
	 *
