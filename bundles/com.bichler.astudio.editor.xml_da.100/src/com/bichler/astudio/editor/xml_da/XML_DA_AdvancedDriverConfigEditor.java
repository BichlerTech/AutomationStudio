...
public class XML_DA_AdvancedDriverConfigEditor extends AbstractOPCConfigDriverViewLinkEditorPart
		implements INamespaceTableChange {
	public static final String ID = "com.bichler.astudio.opcua.editor.XML_DA_AdvancedDriverConfigEditor"; //$NON-NLS-1$
	...
	public XML_DA_AdvancedDriverConfigEditor() {
	}
