...
public class SDKBuiltinsMap {
	...
	static {
		...
		ID_CLASS_MAP.map(Identifiers.BaseDataType, Object.class);
		ID_CLASS_MAP.map(Identifiers.DiagnosticInfo, DiagnosticInfo.class);
		ID_CLASS_MAP.map(Identifiers.Number, Number.class); // 26
		ID_CLASS_MAP.map(Identifiers.Integer, Integer.class); // 27
		ID_CLASS_MAP.map(Identifiers.UInteger, UnsignedInteger.class); // 28
		ID_CLASS_MAP.map(Identifiers.Enumeration, Enumeration.class); // 29
		// ID_CLASS_MAP.map(Identifiers.Image, image.class); // 29
	}
}
