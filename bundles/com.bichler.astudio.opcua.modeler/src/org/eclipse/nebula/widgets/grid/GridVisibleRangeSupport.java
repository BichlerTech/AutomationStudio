...
public class GridVisibleRangeSupport {
	...
	public interface VisibleRangeChangedListener {
		 ...
		 * 
		 * @param event the event holding informations about the change
		 */
	...
	private void calculateChange() {
		...
		if (rangeChangeListener != null) {
			...
			if (lOrigItems.size() != 0 || lNewItems.size() != 0 || lOrigColumns.size() != 0
					|| lNewColumns.size() != 0) {
	 ...
	 * 
	 * @param grid the grid instance the range support is created for
