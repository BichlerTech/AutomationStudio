/*******************************************************************************
 * Copyright (c) 2009 BestSolution.at All rights reserved. This program and the
 * accompanying materials are made available under the terms of the Eclipse
 * Public License v1.0 which accompanies this distribution, and is available at
 * http://www.eclipse.org/legal/epl-v10.html
 *
 * Contributors: tom.schindl@bestsolution.at - initial API and implementation
...
class GridHeaderEditor extends ControlEditor {
		...
		mouseOverListener = new Listener() {
			public void handleEvent(Event event) {
				if (table.getCursor() != null) {
					// We need to reset because it could be that when we left the resizer
					// was active
	 ...
	 * The Table and the editor Control are <b>not</b> disposed.
	 */
	public void dispose() {
	 ...
	 * editor.
	 * 
	 * @param column the zero based index of the column of the cell being tracked by
	 *               this editor
	 */
	void initColumn() {
