 ...
 * wordwrapping in bug 222280 Marty Jones<martybjones@gmail.com> - custom
 * header/footer font in bug 293743 Cserveny Tamas <cserveny.tamas@gmail.com> -
 * min width in bug 295468 Benjamin Bortfeldt<bbortfeldt@gmail.com> - new
 * tooltip support in 300797 Thomas Halm <thha@fernbach.com> - bugfix in 315397
...
public class GridColumn extends Item {
	...
	/**
	 * Does this column contain check boxes? Did the user specify SWT.CHECK in the
	...
	/**
	 * Is a summary column in a column group. Not applicable if this column is not
	 * in a group.
	 */
	private boolean summary = true;
	/**
	 * Is a detail column in a column group. Not applicable if this column is not in
	 * a group.
	 */
	 ...
	 * <code>Grid</code>) and a style value describing its behavior and appearance.
	 * The item is added to the end of the items maintained by its parent.
	 *
	 * @param parent an Grid control which will be the parent of the new instance
	 *               (cannot be null)
	...
	/**
	 * Constructs a new instance of this class given its parent (which must be a
	 * <code>Grid</code>), a style value describing its behavior and appearance, and
	...
	/**
	 * Constructs a new instance of this class given its parent column group (which
	 * must be a <code>GridColumnGroup</code>), a style value describing its
	 ...
	 * sort the data in the table. Valid values include: SWT.UP, SWT.DOWN, SWT.NONE.
	 *
	 ...
	 * the receiver's is pushed, by sending it one of the messages defined in the
	...
	/**
	 * Returns true if the column is visible, false otherwise. If the column is in a
	 * group and the group is not expanded and this is a detail column, returns
	...
	/**
	 * Adds a listener to the list of listeners notified when the column is moved or
	 * resized.
	 *
	 ...
	 * shown when a column group is expanded. If this column was not created in a
	 * column group, this method has no effect.
	 *
	...
	/**
	 * Sets the column as a summary column in a column group. Summary columns are
	 * shown when a column group is collapsed. If this column was not created in a
	 * column group, this method has no effect.
	 *
	...
	/**
	 * Returns the checkable state. If false the checkboxes in the column cannot be
	 * checked.
	 *
	...
	/**
	 * If the argument is true, wraps the text in the receiver's cells. This feature
	 * will not cause the row height to expand to accommodate the wrapped text.
	 * Please use <code>Grid#setItemHeight</code> to change the height of each row.
	 *
	...
	/**
	 * Sets whether or not text is word-wrapped in the header for this column. If
	 * Grid.setAutoHeight(true) is set, the row height is adjusted to accommodate
	 * word-wrapped text.
	 *
	...
	/**
	 * Set a new editor at the top of the control. If there's an editor already set
	 * it is disposed.
	 *
	 * @param control the control to be displayed in the header
	 */
	...
	/**
	 * Returns the receiver's footer text, which will be an empty string if it has
	 * never been set.
	 *
