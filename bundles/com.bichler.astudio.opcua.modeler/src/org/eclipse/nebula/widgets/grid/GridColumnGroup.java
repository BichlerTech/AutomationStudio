 ...
 * mario.winterer@scch.at - bugfix in 244333 Marty Jones<martybjones@gmail.com>
 * - custom header/footer font in bug 293743
 *******************************************************************************/
 ...
 * VERSIONS.
 * </p>
 * Instances of this class represent a column group in a grid widget. A column
 * group header is displayed above grouped columns. The column group can
 * optionally be configured to expand and collapse. A column group in the
 * expanded state shows {@code GridColumn}s whose detail property is true. A
 * column group in the collapsed state shows {@code GridColumn}s whose summary
 * property is true.
 * <p>
 * <dl>
 * <dt><b>Styles:</b></dt>
