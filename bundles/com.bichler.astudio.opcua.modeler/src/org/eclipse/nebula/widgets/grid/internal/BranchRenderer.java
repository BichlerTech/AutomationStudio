 ...
 *
 * Contributors: Michael Houston <schmeeky@gmail.com> - initial implementation
...
public class BranchRenderer extends AbstractRenderer {
	...
	/**
	 * Indicates that a branch should be rendered as a 'T' shape. This is used for
	 * normal children with following siblings
	 */
	public static final int T = V_FULL | H_RIGHT;
	/**
	 * Indicates that a branch should be rendered as an 'L' shape. This is used for
	 * the last child element
	 */
	public static final int L = V_TOP | H_RIGHT;
	/**
	 * Indicates that a branch should be rendered as a 'I' shape. This is used for
	 * connecting children when intermediate children are shown.
	 */
	...
	public void paint(GC gc, Object value) {
		...
		gc.setForeground(getDisplay()
				.getSystemColor(isSelected() ? SWT.COLOR_LIST_SELECTION_TEXT : SWT.COLOR_WIDGET_NORMAL_SHADOW));
		int dy = bounds.y % 2;
		...
		yToggleBottom++;
		// Adjust full height
		// If height is even, we shorten to an odd number of pixels, and start at
	...
	/**
	 * Sets the branches that will be used. The values are taken from the constants
	 * in this class such as I, L, T, NODE, LEAF and NONE, which represent the
	 * branch type to be used for each level.
	 * 
	...
	/**
	 * Sets bounds of the toggle control. This is used to position the downwards
	 * branches
	 * 
