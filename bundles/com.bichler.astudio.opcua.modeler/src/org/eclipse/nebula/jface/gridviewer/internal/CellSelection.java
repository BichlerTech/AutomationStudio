...
public class CellSelection extends SelectionWithFocusRow {
	...
	/**
	 * Creates a structured selection from the given <code>List</code> and element
	 * comparer. If an element comparer is provided, it will be used to determine
	 * equality between structured selection objects provided that they both are
	 * based on the same (identical) comparer. See bug
	 * 
