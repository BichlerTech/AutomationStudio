 ...
 * Schindl <tom.schindl@bestsolution.at> - various significant contributions
 * Mark-Oliver Reiser <mopr1@web.de> - support for differing row heights ; fix
 * in bug 191216
 *******************************************************************************/
...
public final class GridViewerColumn extends ViewerColumn {
	...
	/**
	 * The concrete grid column that is being represented by the
	 * {@code ViewerColumn}.
	 */
	 ...
	 * @param style  the style used to create the column for style bits see
	 *               {@link GridColumn}
