 ...
 *
 * Contributors: Michael Houston <schmeeky@gmail.com> - initial API and
 * implementation Tom Schindl <tom.schindl@bestsolution.at> - bug fix in: 191216
 *******************************************************************************/
...
public class GridTreeViewer extends AbstractTreeViewer {
	 ...
	 * @param rowIndex the index at which the new row should be created under the
	 *                 parent
	...
	/**
	 * Removes the element at the specified index of the parent. The selection is
	 * updated if required.
	 *
	 * @param parentOrTreePath the parent element, the input element, or a tree path
