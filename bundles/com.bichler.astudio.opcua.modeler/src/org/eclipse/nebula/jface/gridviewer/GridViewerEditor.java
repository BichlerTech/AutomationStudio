 ...
 *
 * Contributors: rmcamara@us.ibm.com - initial API and implementation Tom
 * Schindl <tom.schindl@bestsolution.at> - various significant contributions bug
 * fix in: 191216 Jake fisher<fisherja@gmail.com> - fixed minimum height (bug
 * 263489)
 *******************************************************************************/
...
public class GridViewerEditor extends ColumnViewerEditor {
	 ...
	 * @param feature
	 */
	public static void create(GridTableViewer viewer, ColumnViewerEditorActivationStrategy editorActivationStrategy,
			int feature) {
	 ...
	 * @param feature
	 */
	public static void create(GridTreeViewer viewer, ColumnViewerEditorActivationStrategy editorActivationStrategy,
			int feature) {
		viewer.setColumnViewerEditor(new GridViewerEditor(viewer, editorActivationStrategy, feature));
	}
}
