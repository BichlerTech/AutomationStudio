...
// IFindReplaceTargetExtension, IFindReplaceTargetExtension2,
// IFindReplaceTargetExtension3 {
//
// /** The editor */
// private JSSourceViewer fViewer;
//
...
// * the editor
// * @param target
// * the wrapped find/replace target
// */
// public FindReplaceTarget(JSSourceViewer viewer, IFindReplaceTarget target) {
// fViewer = viewer;
// fTarget = target;
// }
//
...
//
// /*
// * @see org.eclipse.jface.text.IFindReplaceTarget#findAndSelect(int,
...
// if (getTarget() != null)
// return getTarget().findAndSelect(offset, findString, searchForward,
...
// /*
// * @see
// * org.eclipse.jface.text.IFindReplaceTargetExtension3#findAndSelect(int,
...
// return ((IFindReplaceTargetExtension3) getTarget()).findAndSelect(
// offset, findString, searchForward, caseSensitive,
...
// return true;
// return fViewer.isEditorInputModifiable();
// }
// return false;
// }
//
// /*
// * @see
// * org.eclipse.jface.text.IFindReplaceTarget#replaceSelection(java.lang.
// * String)
// */
...
// /*
// * @see
// * org.eclipse.jface.text.IFindReplaceTargetExtension3#replaceSelection(
// * String, boolean)
// *
// * @since 3.0
// */
...
// if (getTarget() instanceof IFindReplaceTargetExtension3) {
// ((IFindReplaceTargetExtension3) getTarget()).replaceSelection(text,
// regExReplace);
// return;
// }
//
...
// /*
// * @see
// * org.eclipse.jface.text.IFindReplaceTargetExtension#setScope(org.eclipse
// * .jface.text.IRegion)
// */
...
// /*
// * @see
// * org.eclipse.jface.text.IFindReplaceTargetExtension#getLineSelection()
// */
...
//
// /*
// * @see org.eclipse.jface.text.IFindReplaceTargetExtension#setSelection(int,
// * int)
// */
...
// /*
// * @see
// * org.eclipse.jface.text.IFindReplaceTargetExtension#setScopeHighlightColor
...
// /*
// * @see
// * org.eclipse.jface.text.IFindReplaceTargetExtension#setReplaceAllMode(
// * boolean)
// */
...
// /*
// * @see
// * org.eclipse.ui.texteditor.IFindReplaceTargetExtension2#validateTargetState
// * ()
// */
// public boolean validateTargetState() {
// return fViewer.validateEditorInputState();
// }
// }
