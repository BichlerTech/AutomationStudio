...
public class ComponentOfModelContentProvider implements ITreeContentProvider {
	private UnsignedInteger nodeClassFilter = null;

	public ComponentOfModelContentProvider(UnsignedInteger nodeClassFilter) {
		this.nodeClassFilter = nodeClassFilter;
	}

	public ComponentOfModelContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (Identifiers.Aggregates.equals(parentId)) {
			...
			for (Node child : children) {
				if (Identifiers.HasComponent.equals(child.getNodeId())) {
