...
public class CreateObjectTypeWizard extends AbstractCreateWizard {
	private DetailObjectTypePage detailPage;

	public CreateObjectTypeWizard(Node selectedParent) {
		super(selectedParent);
		setWindowTitle(CustomString.getString(Activator.getDefault().RESOURCE_BUNDLE, "opc.message.extendobjecttype"));
	}

	@Override
	public void addPages() {
		super.addPages();
		this.detailPage = new DetailObjectTypePage();
