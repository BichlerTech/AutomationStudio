...
public class CreateVariableModellingContentProvider implements ITreeContentProvider {
	private UnsignedInteger nodeClassFilter = null;

	public CreateVariableModellingContentProvider(UnsignedInteger nodeClassFilter) {
		this.nodeClassFilter = nodeClassFilter;
	}

	public CreateVariableModellingContentProvider() {
		this.nodeClassFilter = NodeClass.getMask(NodeClass.Variable, NodeClass.Object, NodeClass.Method);
	}

	public CreateVariableModellingContentProvider(List<NodeId> hierarchie) {
		this();
	}
