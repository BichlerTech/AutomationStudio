...
import com.bichler.astudio.opcua.opcmodeler.wizards.create.page.DetailObjectPage;
import com.bichler.astudio.utils.internationalization.CustomString;

public class CreateVariableWizard extends AbstractCreateWizard {
	private DetailObjectPage detailPage;

	public CreateVariableWizard(Node selectedParent) {
		super(selectedParent);
		setWindowTitle(CustomString.getString(Activator.getDefault().RESOURCE_BUNDLE, "opc.message.extendvariable"));
	}

	@Override
	public void addPages() {
		super.addPages();
		this.detailPage = new DetailObjectPage();
