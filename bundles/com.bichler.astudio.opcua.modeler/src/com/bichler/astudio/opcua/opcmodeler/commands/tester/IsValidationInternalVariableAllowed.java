...
public class IsValidationInternalVariableAllowed extends PropertyTester {
	public static final String PROPERTY_NAMESPACE = "com.xcontrol.modeler.opc.tester";
	public static final String PROPERTY_CAN_SHOWVARIABLE = "canShowVariable";

	public IsValidationInternalVariableAllowed() {
	...
	public boolean test(Object receiver, String property, Object[] args, Object expectedValue) {
		if (receiver != null && receiver instanceof TreeSelection) {
			...
			if (obj != null && obj instanceof BrowserVariableInternalModelNode) {
