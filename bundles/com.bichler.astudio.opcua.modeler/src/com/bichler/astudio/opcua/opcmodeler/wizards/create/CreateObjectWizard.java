...
public class CreateObjectWizard extends AbstractCreateWizard {
	private DetailVariablePage detailPage;

	public CreateObjectWizard(Node selectedParent) {
		super(selectedParent);
		setWindowTitle(CustomString.getString(Activator.getDefault().RESOURCE_BUNDLE, "opc.message.extendobject"));
	}

	@Override
	public void addPages() {
		super.addPages();
		this.detailPage = new DetailVariablePage();
