...
import com.bichler.astudio.opcua.opcmodeler.wizards.create.page.DetailReferenceTypePage;
...
public class CreateReferenceTypeWizard extends AbstractCreateWizard {
	private DetailReferenceTypePage detailPage;

	public CreateReferenceTypeWizard(Node selectedParent) {
		super(selectedParent);
		setWindowTitle(CustomString.getString(Activator.getDefault().RESOURCE_BUNDLE, "opc.message.extendreftype"));
	}

	@Override
	public void addPages() {
		super.addPages();
		this.detailPage = new DetailReferenceTypePage();
