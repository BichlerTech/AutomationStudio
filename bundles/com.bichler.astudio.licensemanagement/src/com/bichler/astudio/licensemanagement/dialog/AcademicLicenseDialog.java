...
public class AcademicLicenseDialog extends Dialog {
	 ...
	 * @param parentShell
	 */
	public AcademicLicenseDialog(Shell parentShell) {
		super(parentShell);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		gridLayout.numColumns = 2;
				...
				lblHeader.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, true, false, 1, 1));
						...
						lblHeader.setText(CustomString.getString(LicManActivator.getDefault().RESOURCE_BUNDLE, "Academic"));
		...
		lblDescription.setText(
				CustomString.getString(LicManActivator.getDefault().RESOURCE_BUNDLE, "dialog.academic.description"));
