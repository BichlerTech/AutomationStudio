...
public final class SiemensSharedImages {
	private SiemensSharedImages() { // do nothing
	}
	...
	public static final String ICON_SELECTNONE = ICONS_PATH + ICONS_16_PATH + "selectnone.png";
	public static final String ICON_SELECTALL = ICONS_PATH + ICONS_16_PATH + "selectall.png";

	public static final String ICON_DELETE = ICONS_PATH + ICONS_24_PATH + "delete.png"; //$NON-NLS-1$
	public static final String ICON_ADD = ICONS_PATH + ICONS_24_PATH + "add.png";
	public static final String ICON_IMPORT = ICONS_PATH + ICONS_24_PATH + "import.png"; //$NON-NLS-1$
	public static final String ICON_EXPORT = ICONS_PATH + ICONS_24_PATH + "export.png";
	...
	public static ImageDescriptor getImageDescriptor(String key) {
		return SiemensActivator.getDefault().getImageRegistry().getDescriptor(key);
	}

	public static Image getImage(String key) {
		return SiemensActivator.getDefault().getImageRegistry().get(key);
	}
}
