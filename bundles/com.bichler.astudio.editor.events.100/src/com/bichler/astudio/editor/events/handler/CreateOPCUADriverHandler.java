...
import com.bichler.astudio.editor.events.EventsActivator;
...
{
  public static final String ID = "com.bichler.astudio.editor.events.1.0.0.createdrivercommand";
  ...
  public Object execute(ExecutionEvent event) throws ExecutionException
  {
    ...
    File defaultDrvStore = EventsActivator.getDefault().getFile(EventsActivator.getDefault().getBundle(),
