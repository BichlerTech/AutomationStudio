...
public final class DevCoreSharedImages {

	private DevCoreSharedImages() { // do nothing
	}
	...
	public static ImageDescriptor getImageDescriptor(String key) {
		return DevCoreActivator.getDefault().getImageRegistry().getDescriptor(key);
	}

	public static Image getImage(String key) {
		return DevCoreActivator.getDefault().getImageRegistry().get(key);
	}
