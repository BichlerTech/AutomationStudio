...
public class CNClassPath extends CNPath {
	...
	public String toString() {
		if (attr > 0)
			return String.format("Path (3 el) Class(0x20) 0x%X (%s), instance(0x24) %d, attrib.(0x30) 0x%X", class_code,
					class_name, instance, attr);
		return String.format("Path (2 el) Class(0x20) 0x%X (%s), instance(0x24) %d", class_code, class_name, instance);
	}
}
