...
public enum CNService {
	Get_Attribute_All(0x01), Get_Attribute_Single(0x0E), // Spec 6 p. 43
	...
	CM_Unconnected_Send(0x52), Get_Instance_Attribute_List(0x55),

	Get_Attribute_All_Reply(0x01 | 0x80), Get_Attribute_Single_Reply(0x0E | 0x80), CIP_MultiRequest_Reply(0x0A | 0x80),
	CIP_ReadData_Reply(0x4C | 0x80), CIP_WriteData_Reply(0x4D | 0x80), CM_Unconnected_Send_Reply(0x52 | 0x80);
	 ...
	 * 
	 * @return {@link CNService} for the reply, or <code>null</code> if there is no
	 *         known reply
	 */
