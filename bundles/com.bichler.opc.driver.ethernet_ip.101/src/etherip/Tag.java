 ...
 * 
 * <p>
 * Initially, the data for the tag is read to get the original value and
 * determine the data type. From then on, tag can be written.
 * 
 * @author Kay Kasemir
 */
public class Tag {
	 ...
	 * <p>
	 * This is either the most recent value read from the device, or the value that
	 * is about to be written to the device.
	 * 
	 * @return {@link CIPData}
	 */
	 ...
	 * @throws IllegalStateException     if tag has never been read, so data type is
	 *                                   unknown
