...
public class SiemensDriverEditor extends AbstractOPCDriverConfigSelectionEditorPart {
	public final static String ID = "com.bichler.astudio.editor.siemens.102.SiemensDriverEditor"; //$NON-NLS-1$
	...
	private void createDriverConfigSection(Composite composite) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(txt_IP, "browsenameindex");
